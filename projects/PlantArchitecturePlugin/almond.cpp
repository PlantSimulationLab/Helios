...
void PlantArchitecture::addAlmondShoot() {
    ...
    phytomer_parameters_proleptic.inflorescence.fruit_prototype_scale = 0.015;
    ...
    phytomer_parameters_proleptic.internode.petioles_per_internode = 1;
    ...
    phytomer_parameters_trunk.leaf.prototype_scale = 0.075;
    phytomer_parameters_trunk.inflorescence.flower_prototype_scale = 0.015;
    phytomer_parameters_trunk.inflorescence.fruit_pitch.uniformDistribution(-0.2*M_PI,0.*M_PI);
    ...
    shoot_parameters_trunk.phyllochron = 1;
    shoot_parameters_trunk.elongation_rate = 0.004;
    shoot_parameters_trunk.girth_growth_rate = 0.001;
    shoot_parameters_trunk.defineChildShootTypes({"sylleptic","proleptic"},{1.,0});
    shoot_parameters_trunk.phyllotactic_angle = deg2rad(130);
    shoot_parameters_trunk.growth_requires_dormancy = false;
    shoot_parameters_trunk.child_insertion_angle_tip = 0.1*M_PI;
    ...
    shoot_parameters_proleptic.phyllotactic_angle = M_PI;//.uniformDistribution( deg2rad(130), deg2rad(145) );
    shoot_parameters_proleptic.elongation_rate = 0.004;
    shoot_parameters_proleptic.bud_break_probability = 1;
    shoot_parameters_proleptic.bud_time = 0;
    shoot_parameters_proleptic.gravitropic_curvature = 0;//150;
    shoot_parameters_proleptic.shoot_internode_taper = 1;
    shoot_parameters_proleptic.phytomer_parameters = phytomer_parameters_proleptic;
    shoot_parameters_proleptic.child_insertion_angle_tip = 0.5*M_PI;
...
//    shoot_parameters_proleptic.defineChildShootTypes({"sylleptic","proleptic"},{0.,1});
    ...
    shoot_parameters_sylleptic.bud_break_probability = 0;
    ...
    shoot_parameters_sylleptic.defineChildShootTypes({"sylleptic","proleptic"},{0.,1});
    ...
    uint uID_trunk = addBaseStemShoot(plant0, 12, make_AxisRotation(0, 0, 0. * M_PI), "trunk");
...
//    shoot_parameters_proleptic.defineChildShootTypes({"sylleptic","proleptic"},{0.,1});
    ...
    uint uID_trunk = addBaseStemShoot(plant0, 12, make_AxisRotation(context.randu(0, 0.2 * M_PI), context.randu(0, 2 * M_PI), 0. * M_PI), "trunk");
