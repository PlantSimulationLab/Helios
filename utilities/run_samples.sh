...
SAMPLES=("context_selftest" "visualizer_selftest" "radiation_selftest" "energybalance_selftest" "solarposition_selftest" "stomatalconductance_selftest" "photosynthesis_selftest" "lidar_selftest" "aeriallidar_selftest" "voxelintersection_selftest" "tutorial0"  "tutorial1")
