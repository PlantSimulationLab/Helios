...
//        }
    ...
    setPlantPhenologicalThresholds(plantID, 0, -1, 1, 3, 8, 20, false);
...
void PlantArchitecture::initializeAppleTreeShoots(){
    ...
    phytomer_parameters_apple.leaf.prototype_function = AppleLeafPrototype;
    phytomer_parameters_apple.leaf.prototype_scale = 0.12;
    phytomer_parameters_apple.leaf.unique_prototypes = 1;
    phytomer_parameters_apple.leaf.subdivisions = 3;
    ...
    shoot_parameters_proleptic.vegetative_bud_break_time = 0;
    shoot_parameters_proleptic.leaf_flush_count = 1;
    shoot_parameters_proleptic.gravitropic_curvature = 600;
    shoot_parameters_proleptic.tortuosity = 3;
    shoot_parameters_proleptic.internode_radius_initial = 0.006;
    shoot_parameters_proleptic.insertion_angle_tip.uniformDistribution( 30, 35);
...
//    enableEpicormicChildShoots(plantID,"sylleptic",0.001);
    ...
    for( int i=0; i<Nscaffolds; i++ ) {
        ...
        uint uID_shoot = addChildShoot( plantID, uID_trunk, getShootNodeCount(plantID,uID_trunk)-i-1, context_ptr->randu(7, 9), make_AxisRotation(pitch, (float(i) + context_ptr->randu(-0.2f, 0.2f)) / float(Nscaffolds) * 2 * M_PI, 0), 0.007, 0.06, 1.f, 1.f, 0.5, "proleptic", 0);
...
//    phytomer_parameters.leaf.subdivisions = 6;
    ...
    shoot_parameters.internode_radius_initial = 0.00025;
...
void PlantArchitecture::initializeBindweedShoots() {
    ...
    phytomer_parameters_bindweed.leaf.unique_prototypes = 1;
    ...
    shoot_parameters_primary.internode_radius_initial = 0.0015;
...
uint PlantArchitecture::buildBindweedPlant(const helios::vec3 &base_position) {
    ...
    setPlantPhenologicalThresholds(plantID, 0, -1, 7, -1, -1, 100, false);
...
//    shoot_parameters_trifoliate.leaf_flush_count = 1; (default)
    shoot_parameters_trifoliate.elongation_rate = 0.25;
    shoot_parameters_trifoliate.girth_area_factor = 2.f;
    shoot_parameters_trifoliate.vegetative_bud_break_time = 8;
    shoot_parameters_trifoliate.vegetative_bud_break_probability = 0.1;
...
//    shoot_parameters_trifoliate.determinate_shoot_growth = true; (default)
    ...
    shoot_parameters_unifoliate.vegetative_bud_break_probability = 1.0;
    ...
    shoot_parameters_unifoliate.vegetative_bud_break_time = 4;
...
uint PlantArchitecture::buildBeanPlant(const helios::vec3 &base_position) {
    ...
    setPlantPhenologicalThresholds(plantID, 0, 15, 3, 3, 5, 100, false);
...
uint PlantArchitecture::buildCheeseweedPlant(const helios::vec3 &base_position) {
    ...
    setPlantPhenologicalThresholds(plantID, 0, 1000, 3, 1000, 5, 100, false);
...
void PlantArchitecture::initializeCowpeaShoots() {
    ...
    phytomer_parameters_trifoliate.peduncle.length.uniformDistribution(0.25,0.27);
    ...
    phytomer_parameters_trifoliate.inflorescence.flowers_per_peduncle = 4;//.uniformDistribution(1, 3);
    ...
    phytomer_parameters_trifoliate.inflorescence.fruit_gravity_factor_fraction.uniformDistribution(0.,0.7);
...
//    shoot_parameters_trifoliate.determinate_shoot_growth = true; (default)
    ...
    shoot_parameters_unifoliate.phytomer_parameters = phytomer_parameters_unifoliate;
    shoot_parameters_unifoliate.max_nodes = 1;
    shoot_parameters_unifoliate.vegetative_bud_break_probability = 1;
    shoot_parameters_unifoliate.flower_bud_break_probability = 0;
    shoot_parameters_unifoliate.insertion_angle_tip = 40;
    shoot_parameters_unifoliate.insertion_angle_decay_rate = 0;
    shoot_parameters_unifoliate.vegetative_bud_break_time = 3;
    shoot_parameters_unifoliate.defineChildShootTypes({"trifoliate"},{1.0});
...
uint PlantArchitecture::buildCowpeaPlant(const helios::vec3 &base_position) {
    ...
    setPlantPhenologicalThresholds(plantID, 0, 18, 3, 3, 5, 100, false);
...
void PlantArchitecture::initializeGrapevineVSPShoots() {
    ...
    phytomer_parameters_grapevine.internode.color = make_RGBcolor(0.1,0.048,0.023);
    ...
    phytomer_parameters_grapevine.leaf.prototype_function = GrapevineLeafPrototype;
    phytomer_parameters_grapevine.leaf.prototype_scale = 0.2;
    phytomer_parameters_grapevine.leaf.subdivisions = 5;
    phytomer_parameters_grapevine.leaf.unique_prototypes = 10;
...
//    phytomer_parameters_grapevine.phytomer_callback_function = GrapevinePhytomerCallbackFunction;
    ...
    shoot_parameters_main.vegetative_bud_break_probability = 0.1;
    shoot_parameters_main.vegetative_bud_break_time = 4;
    shoot_parameters_main.phyllochron = 1;
    ...
    shoot_parameters_main.internode_radius_initial = 0.003;
...
//    shoot_parameters_cane.phytomer_parameters.internode.image_texture = "plugins/plantarchitecture/assets/textures/GrapeBark.jpg";
    ...
    shoot_parameters_cane.vegetative_bud_break_probability = 0.9;
...
uint PlantArchitecture::buildGrapevineVSP(const helios::vec3 &base_position) {
    ...
    uint uID_stem = addBaseStemShoot(plantID, 8, make_AxisRotation(context_ptr->randu(0,0.05*M_PI), 0, 0), 0.03, 0.1, 1, 1, 0.1, "grapevine_trunk");
...
//    makePlantDormant(plantID);
    ...
    setPlantPhenologicalThresholds(plantID, 0, -1, -1, 10, 10, 25, false);
...
void PlantArchitecture::initializeMaizeShoots() {
    ...
    phytomer_parameters_maize.leaf.prototype_function = MaizeLeafPrototype;
    phytomer_parameters_maize.leaf.prototype_scale = 0.5;
    phytomer_parameters_maize.leaf.subdivisions = 50;
    phytomer_parameters_maize.leaf.unique_prototypes = 10;

    phytomer_parameters_maize.peduncle.length = 0.1f;
    phytomer_parameters_maize.peduncle.radius = 0.0025;
    ...
    shoot_parameters_mainstem.vegetative_bud_break_probability = 0.5;
    ...
    shoot_parameters_mainstem.gravitropic_curvature.uniformDistribution(-400,0);
...
uint PlantArchitecture::buildMaizePlant(const helios::vec3 &base_position) {
    ...
    setPlantPhenologicalThresholds(plantID, 0, -1, -1, 2, 5, 100, false);
...
void PlantArchitecture::initializeOliveTreeShoots(){
    ...
    phytomer_parameters_olive.leaf.prototype_function = OliveLeafPrototype;
    phytomer_parameters_olive.leaf.prototype_scale = 0.06;
    phytomer_parameters_olive.leaf.unique_prototypes = 1;
    phytomer_parameters_olive.leaf.subdivisions = 1;
...
//    phytomer_parameters_olive.inflorescence.flower_prototype_function = OliveFlowerPrototype;
    ...
    shoot_parameters_trunk.max_nodes = 20;
    shoot_parameters_trunk.girth_area_factor = 2.5f;
    shoot_parameters_trunk.internode_radius_initial = 0.01;
    shoot_parameters_trunk.vegetative_bud_break_probability = 0;
    shoot_parameters_trunk.vegetative_bud_break_time = 0;
    shoot_parameters_trunk.tortuosity = 1;
...
//    shoot_parameters_proleptic.phytomer_parameters.phytomer_creation_function = OlivePhytomerCreationFunction;
    ...
    shoot_parameters_proleptic.phyllochron = 1.0;
    shoot_parameters_proleptic.elongation_rate = 0.25;
    shoot_parameters_proleptic.girth_area_factor = 5.f;
    shoot_parameters_proleptic.vegetative_bud_break_probability = 0.15;
    shoot_parameters_proleptic.vegetative_bud_break_time = 0;
    shoot_parameters_proleptic.leaf_flush_count = 1;
    shoot_parameters_proleptic.gravitropic_curvature = 550;
    shoot_parameters_proleptic.tortuosity = 4;
...
uint PlantArchitecture::buildOliveTree(const helios::vec3 &base_position) {
    ...
    uint uID_trunk = addBaseStemShoot(plantID, 19, make_AxisRotation(context_ptr->randu(0.f, 0.025f * M_PI), context_ptr->randu(0.f, 2.f * M_PI), context_ptr->randu(0.f, 2.f * M_PI)), 0.015, 0.008, 1.f, 1.f, 0, "trunk");
    appendPhytomerToShoot( plantID, uID_trunk, shoot_types.at("trunk").phytomer_parameters, 0, 0.01, 1, 1);
    ...
    for( int i=0; i<Nscaffolds; i++ ) {
        ...
        uint uID_shoot = addChildShoot( plantID, uID_trunk, getShootNodeCount(plantID,uID_trunk)-i-1, context_ptr->randu(5, 7), make_AxisRotation(pitch, (float(i) + context_ptr->randu(-0.2f, 0.2f)) / float(Nscaffolds) * 2 * M_PI, 0), 0.007, 0.06, 1.f, 1.f, 0.5, "scaffold", 0);

    }

    makePlantDormant(plantID);

    setPlantPhenologicalThresholds(plantID, 0, -1, 1, 3, 8, 20, 25, true);
...
void PlantArchitecture::initializePistachioTreeShoots(){
    ...
    phytomer_parameters_pistachio.leaf.prototype_function = PistachioLeafPrototype;
    ...
    phytomer_parameters_pistachio.leaf.unique_prototypes = 5;
    phytomer_parameters_pistachio.leaf.subdivisions = 3;
...
//    phytomer_parameters_pistachio.inflorescence.flower_prototype_function = PistachioFlowerPrototype;
    ...
    shoot_parameters_proleptic.vegetative_bud_break_time = 0;
    shoot_parameters_proleptic.leaf_flush_count = 1;
    shoot_parameters_proleptic.gravitropic_curvature = 400;
...
uint PlantArchitecture::buildPistachioTree(const helios::vec3 &base_position) {
    ...
    uint uID_trunk = addBaseStemShoot(plantID, 19, make_AxisRotation(context_ptr->randu(0.f, 0.05f * M_PI), context_ptr->randu(0.f, 2.f * M_PI), context_ptr->randu(0.f, 2.f * M_PI)), 0.015, 0.05, 1.f, 1.f, 0, "trunk");
    appendPhytomerToShoot( plantID, uID_trunk, shoot_types.at("trunk").phytomer_parameters, 0, 0.01, 1, 1);
    ...
    for( int i=0; i<Nscaffolds; i++ ) {
        ...
        uint uID_shoot = addChildShoot( plantID, uID_trunk, getShootNodeCount(plantID,uID_trunk)-i-1, 1, make_AxisRotation(pitch, (float(i) + context_ptr->randu(-0.2f, 0.2f)) / float(Nscaffolds) * 2 * M_PI, 0), 0.007, 0.06, 1.f, 1.f, 0.5, "proleptic", 0);

    }

    makePlantDormant(plantID);

    setPlantPhenologicalThresholds(plantID, 0, -1, -1, 4, 8, 20, false);
...
void PlantArchitecture::initializePuncturevineShoots() {
    ...
    phytomer_parameters_puncturevine.leaf.subdivisions = 1;
...
uint PlantArchitecture::buildPuncturevinePlant(const helios::vec3 &base_position) {
    ...
    setPlantPhenologicalThresholds(plantID, 0, -1, 7, 1000, 5, 100, false);
...
uint PlantArchitecture::buildEasternRedbudPlant(const helios::vec3 &base_position) {
    ...
    setPlantPhenologicalThresholds(plantID, 0, -1, 1, 3, 3, 12, false);
...
void PlantArchitecture::initializeRiceShoots() {
    ...
    phytomer_parameters_rice.leaf.prototype_function = RiceLeafPrototype;
    phytomer_parameters_rice.leaf.prototype_scale = 0.15;
    phytomer_parameters_rice.leaf.subdivisions = 20;
    phytomer_parameters_rice.leaf.unique_prototypes = 10;

    phytomer_parameters_rice.peduncle.length = 0.15;
    ...
    phytomer_parameters_rice.peduncle.curvature.uniformDistribution(-1000,-400);
...
//    phytomer_parameters_rice.phytomer_creation_function = RicePhytomerCreationFunction;
    ...
    shoot_parameters_mainstem.phyllochron = 0.8;
    shoot_parameters_mainstem.elongation_rate = 0.2;
...
void PlantArchitecture::initializeButterLettuceShoots() {
    ...
    phytomer_parameters.leaf.roll = 0;
    phytomer_parameters.leaf.prototype_function = ButterLettuceLeafPrototype;
...
uint PlantArchitecture::buildButterLettucePlant(const helios::vec3 &base_position) {
    ...
    setPlantPhenologicalThresholds(plantID, 0, 1000, 10, 60, 5, 100, false);
...
void PlantArchitecture::initializeSorghumShoots() {
    ...
    phytomer_parameters_sorghum.peduncle.length = 0.5;
...
void PlantArchitecture::initializeStrawberryShoots() {
    ...
    phytomer_parameters.leaf.pitch.uniformDistribution(-30,0);
    ...
    shoot_parameters.girth_area_factor = 6.f;
...
uint PlantArchitecture::buildStrawberryPlant(const helios::vec3 &base_position) {
    ...
    setPlantPhenologicalThresholds(plantID, 0, -1, 10, 3, 1, 100, false);
...
void PlantArchitecture::initializeTomatoShoots() {
    ...
    shoot_parameters.insertion_angle_decay_rate = 0;
    shoot_parameters.internode_length_max = 0.06;
    shoot_parameters.internode_length_min = 0.0;
    shoot_parameters.internode_length_decay_rate = 0;
    shoot_parameters.base_roll = 90;
    shoot_parameters.base_yaw.uniformDistribution(-20,20);
...
uint PlantArchitecture::buildTomatoPlant(const helios::vec3 &base_position) {
    ...
    setPlantPhenologicalThresholds(plantID, 0, -1, 10, 3, 2, 100, false);
...
void PlantArchitecture::initializeWalnutTreeShoots(){
    ...
    phytomer_parameters_walnut.leaf.prototype_function = WalnutLeafPrototype;
    ...
    phytomer_parameters_walnut.leaf.unique_prototypes = 5;
    phytomer_parameters_walnut.leaf.subdivisions = 3;
    ...
    shoot_parameters_proleptic.elongation_rate = 0.25;
    shoot_parameters_proleptic.girth_area_factor = 10.f;
    shoot_parameters_proleptic.vegetative_bud_break_probability = 0.1;
...
void PlantArchitecture::initializeWheatShoots() {
    ...
    phytomer_parameters_wheat.peduncle.length = 0.14;
    phytomer_parameters_wheat.peduncle.radius = 0.0015;
...
uint PlantArchitecture::buildWheatPlant(const helios::vec3 &base_position) {
    ...
    uint uID_stem = addBaseStemShoot(plantID, 1, make_AxisRotation(context_ptr->randu(0.f, 0.1f * M_PI), context_ptr->randu(0.f, 2.f * M_PI), context_ptr->randu(0.f, 2.f * M_PI)), 0.001, 0.04, 0.01, 0.01, 0, "mainstem");
