...
void StomatalConductanceModel::setModelCoefficients(std::string speciesCoefficients) {
    BMFcoefficients coeffs;
    std::string s = speciesCoefficients;
    BMFcoeffs = coeffs;
    BMFmodel_coefficients.clear();
    model = "BMF";
}

void StomatalConductanceModel::setModelCoefficients(std::string speciesCoefficients, const std::vector<uint> &UUIDs) {
    BMFcoefficients coeffs;
    std::string s = speciesCoefficients;
    coeffs = getModelCoefficients(s);
    for (uint UUID: UUIDs) {
        BMFmodel_coefficients[UUID] = coeffs;
    }
    model = "BMF";
...
BMFcoefficients StomatalConductanceModel::getModelCoefficients(std::string speciesCoefficients) {
    BMFcoefficients coeffs;
    bool defaultSpecies = false;
    const std::string &s = speciesCoefficients;
