...
int perf(std::size_t Count) {
...

    {
        ...
        for (int i = 0; i < static_cast<int>(Count); ++i) Result[i] = glm::log2(static_cast<int>(i));
...

    {
        ...
        for (int i = 0; i < static_cast<int>(Count); ++i) Result[i] = glm::log2(glm::ivec4(i));
...

    {
        ...
        for (std::size_t i = 0; i < Count; ++i) Result[i] = glm::log2(static_cast<float>(i));
...

    {
        ...
        for (int i = 0; i < static_cast<int>(Count); ++i) Result[i] = glm::log2(glm::vec4(i));
