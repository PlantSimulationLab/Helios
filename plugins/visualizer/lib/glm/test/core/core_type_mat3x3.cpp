...
int test_mat3x3() {
    glm::dmat3 Mat0(glm::dvec3(0.6f, 0.2f, 0.3f), glm::dvec3(0.2f, 0.7f, 0.5f), glm::dvec3(0.3f, 0.5f, 0.7f));
...
int test_inverse() {
    ...
    {
        glm::mat3 const Matrix(glm::vec3(0.6f, 0.2f, 0.3f), glm::vec3(0.2f, 0.7f, 0.5f), glm::vec3(0.3f, 0.5f, 0.7f));
...
int test_ctr() {
    ...
    glm::mat3x3 m0(glm::vec3(0, 1, 2), glm::vec3(3, 4, 5), glm::vec3(6, 7, 8));

    glm::mat3x3 m1{0, 1, 2, 3, 4, 5, 6, 7, 8};

    glm::mat3x3 m2{{0, 1, 2}, {3, 4, 5}, {6, 7, 8}};
    ...
    std::vector<glm::mat3x3> v1{{0, 1, 2, 3, 4, 5, 6, 7, 8}, {0, 1, 2, 3, 4, 5, 6, 7, 8}};

    std::vector<glm::mat3x3> v2{{{0, 1, 2}, {3, 4, 5}, {6, 7, 8}}, {{0, 1, 2}, {3, 4, 5}, {6, 7, 8}}};
