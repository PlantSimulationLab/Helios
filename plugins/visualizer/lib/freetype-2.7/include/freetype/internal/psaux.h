...
#define T1_NEW_SIMPLE_FIELD(_ident, _type, _fname, _dict) \
    {_ident, T1CODE, _type, 0, FT_FIELD_OFFSET(_fname), FT_FIELD_SIZE(_fname), 0, 0, _dict},

#define T1_NEW_CALLBACK_FIELD(_ident, _reader, _dict) \
    {_ident, T1CODE, T1_FIELD_TYPE_CALLBACK, (T1_Field_ParseFunc)_reader, 0, 0, 0, 0, _dict},
...
#define T1_NEW_TABLE_FIELD2(_ident, _type, _fname, _max, _dict) \
    {_ident, T1CODE, _type, 0, FT_FIELD_OFFSET(_fname), FT_FIELD_SIZE_DELTA(_fname), _max, 0, _dict},
...
#define T1_FIELD_FIXED_1000(_ident, _fname, _dict) T1_NEW_SIMPLE_FIELD(_ident, T1_FIELD_TYPE_FIXED_1000, _fname, _dict)
...
typedef struct PS_Parser_FuncsRec_ {
    ...
    FT_Error (*to_bytes)(PS_Parser parser, FT_Byte* bytes, FT_Offset max_bytes, FT_ULong* pnum_bytes,
                         FT_Bool delimiters);
    ...
    FT_Error (*load_field)(PS_Parser parser, const T1_Field field, void** objects, FT_UInt max_objects,
                           FT_ULong* pflags);

    FT_Error (*load_field_table)(PS_Parser parser, const T1_Field field, void** objects, FT_UInt max_objects,
                                 FT_ULong* pflags);
...
#define IS_PS_TOKEN(cur, limit, token)                                                   \
    ((char)(cur)[0] == (token)[0] &&                                                     \
     ((cur) + sizeof((token)) == (limit) ||                                              \
      ((cur) + sizeof((token)) < (limit) && IS_PS_DELIM((cur)[sizeof((token)) - 1]))) && \
