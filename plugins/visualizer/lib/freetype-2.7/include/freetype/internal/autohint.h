...
/*                                                                       */
typedef FT_Error (*FT_AutoHinter_GlyphLoadFunc)(FT_AutoHinter hinter, FT_GlyphSlot slot, FT_Size size,
...
#define FT_DEFINE_AUTOHINTER_INTERFACE(class_, reset_face_, get_global_hints_, done_global_hints_, load_glyph_) \
    ...
    const FT_AutoHinter_InterfaceRec class_ = {reset_face_, get_global_hints_, done_global_hints_, load_glyph_};

#else /* FT_CONFIG_OPTION_PIC */

#define FT_DEFINE_AUTOHINTER_INTERFACE(class_, reset_face_, get_global_hints_, done_global_hints_, load_glyph_) \
    void FT_Init_Class_##class_(FT_Library library, FT_AutoHinter_InterfaceRec* clazz) {                        \
        FT_UNUSED(library);                                                                                     \
                                                                                                                \
