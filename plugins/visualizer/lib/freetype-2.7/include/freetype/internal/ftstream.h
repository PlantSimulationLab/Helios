...
#define FT_PEEK_OFF3(p) FT_INT32(FT_BYTE_U32(p, 0, 16) | FT_BYTE_U32(p, 1, 8) | FT_BYTE_U32(p, 2, 0))
...
#define FT_PEEK_OFF3_LE(p) FT_INT32(FT_BYTE_U32(p, 2, 16) | FT_BYTE_U32(p, 1, 8) | FT_BYTE_U32(p, 0, 0))
