...
typedef FT_Error (*PS_Unicodes_InitFunc)(FT_Memory memory, PS_Unicodes unicodes, FT_UInt num_glyphs,
...
#define FT_DEFINE_SERVICE_PSCMAPSREC(class_, unicode_value_, unicodes_init_, unicodes_char_index_,                  \
                                     unicodes_char_next_, macintosh_name_, adobe_std_strings_, adobe_std_encoding_, \
                                     adobe_expert_encoding_)                                                        \
    static const FT_Service_PsCMapsRec class_ = {unicode_value_,      unicodes_init_,        unicodes_char_index_,  \
...
#define FT_DEFINE_SERVICE_PSCMAPSREC(class_, unicode_value_, unicodes_init_, unicodes_char_index_,                  \
                                     unicodes_char_next_, macintosh_name_, adobe_std_strings_, adobe_std_encoding_, \
                                     adobe_expert_encoding_)                                                        \
    void FT_Init_Class_##class_(FT_Library library, FT_Service_PsCMapsRec* clazz) {                                 \
        FT_UNUSED(library);                                                                                         \
                                                                                                                    \
