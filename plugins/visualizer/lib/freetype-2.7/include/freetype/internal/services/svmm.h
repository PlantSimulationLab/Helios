...
#define FT_DEFINE_SERVICE_MULTIMASTERSREC(class_, get_mm_, set_mm_design_, set_mm_blend_, get_mm_var_,     \
                                          set_var_design_)                                                 \
    static const FT_Service_MultiMastersRec class_ = {get_mm_, set_mm_design_, set_mm_blend_, get_mm_var_, \
                                                      set_var_design_};
...
#define FT_DEFINE_SERVICE_MULTIMASTERSREC(class_, get_mm_, set_mm_design_, set_mm_blend_, get_mm_var_, \
                                          set_var_design_)                                             \
    void FT_Init_Class_##class_(FT_Service_MultiMastersRec* clazz) {                                   \
