...
#define FT_DEFINE_SERVICE_PSINFOREC(class_, get_font_info_, ps_get_font_extra_, has_glyph_names_, get_font_private_, \
                                    get_font_value_)                                                                 \
    static const FT_Service_PsInfoRec class_ = {get_font_info_, ps_get_font_extra_, has_glyph_names_,                \
...
#define FT_DEFINE_SERVICE_PSINFOREC(class_, get_font_info_, ps_get_font_extra_, has_glyph_names_, get_font_private_, \
                                    get_font_value_)                                                                 \
    void FT_Init_Class_##class_(FT_Library library, FT_Service_PsInfoRec* clazz) {                                   \
        FT_UNUSED(library);                                                                                          \
                                                                                                                     \
