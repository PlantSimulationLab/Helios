...
FT_LOCAL(FT_Error)
af_cjk_hints_apply(FT_UInt glyph_index, AF_GlyphHints hints, FT_Outline* outline, AF_CJKMetrics metrics);
...
FT_LOCAL(void)
af_cjk_metrics_init_widths(AF_CJKMetrics metrics, FT_Face face);
