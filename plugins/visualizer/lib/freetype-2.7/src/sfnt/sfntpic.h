...
#define SFNT_SERVICES_GET (GET_PIC(library)->sfnt_services)
#define SFNT_SERVICE_GLYPH_DICT_GET (GET_PIC(library)->sfnt_service_glyph_dict)
#define SFNT_SERVICE_PS_NAME_GET (GET_PIC(library)->sfnt_service_ps_name)
#define TT_SERVICE_CMAP_INFO_GET (GET_PIC(library)->tt_service_get_cmap_info)
#define TT_CMAP_CLASSES_GET (GET_PIC(library)->tt_cmap_classes)
#define SFNT_SERVICE_SFNT_TABLE_GET (GET_PIC(library)->sfnt_service_sfnt_table)
#define SFNT_SERVICE_BDF_GET (GET_PIC(library)->sfnt_service_bdf)
#define SFNT_INTERFACE_GET (GET_PIC(library)->sfnt_interface)

/* see sfntpic.c for the implementation */
void sfnt_module_class_pic_free(FT_Library library);

FT_Error sfnt_module_class_pic_init(FT_Library library);
