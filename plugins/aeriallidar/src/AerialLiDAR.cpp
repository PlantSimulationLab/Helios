...
void AerialLiDARcloud::disableMessages() {
    printmessages = false;
}

void AerialLiDARcloud::enableMessages() {
    printmessages = true;
}

uint AerialLiDARcloud::getScanCount() {
    return scans.size();
}
...
uint AerialLiDARcloud::getHitCount() const {
    return hits.size();
}
...
helios::vec3 AerialLiDARcloud::getGridCenter() const {

    return gridcenter;
}

helios::vec3 AerialLiDARcloud::getGridExtent() const {

    return gridextent;
}

helios::int3 AerialLiDARcloud::getGridResolution() const {

    return gridresolution;
}

float AerialLiDARcloud::getGridRotation() const {
...
vec3 AerialLiDARcloud::getCellSize() const {
...
void AerialLiDARcloud::calculateCoverFraction() {
...
void AerialLiDARcloud::calculateHitGridCell() {
