...
SorghumCanopyParameters::SorghumCanopyParameters(){
    ...
    s3_stem_subdivisions = 50;

    s3_leaf_size = make_vec2(0.8,0.08);

    s3_leaf_subdivisions = 30;
    ...
    s4_stem_subdivisions = 50;

    s4_fruit_size = make_vec2(0.2,0.06);

    s4_fruit_subdivisions = 50;

    s4_leaf_size = make_vec2(0.8,0.08);

    s4_leaf_subdivisions = 30;
    ...
    s5_stem_subdivisions = 50;

    s5_fruit_size = make_vec2(0.3,0.08);

    s5_fruit_subdivisions = 50;

    seed_texture_file = "plugins/canopygenerator/textures/Sorghum_seed.jpg";

    s5_leaf_size = make_vec2(0.9,0.125);

    s5_leaf_subdivisions = 40;
...
/*
	...
	gobletgrapevineparameters.shoots_tip_angle = uint(spa);
        ...
        for (pugi::xml_node s = cgen.child("SorghumCanopyParameters"); s; s = s.next_sibling("SorghumCanopyParameters")) {
            ...
            int s1_leaf_subdivisions = XMLloadint(s, "s1_leaf_subdivisions");
            if (s1_leaf_subdivisions != nullvalue_f) {
                sorghumcanopyparameters.s1_leaf_subdivisions = uint(s1_leaf_subdivisions);
            }
            ...
            int s2_leaf_subdivisions = XMLloadint(s, "s2_leaf_subdivisions");
            if (s2_leaf_subdivisions != nullvalue_f) {
                sorghumcanopyparameters.s2_leaf_subdivisions = uint(s2_leaf_subdivisions);
            }
            ...
            int s3_leaf_subdivisions = XMLloadint(s, "s3_leaf_subdivisions");
            if (s3_leaf_subdivisions != nullvalue_f) {
                sorghumcanopyparameters.s3_leaf_subdivisions = uint(s3_leaf_subdivisions);
            }
            ...
            vec2 s4_fruit_size = XMLloadvec2(s, "s4_fruit_size");
            if (s4_fruit_size.x != nullvalue_f && s4_fruit_size.y != nullvalue_f) {
                sorghumcanopyparameters.s4_fruit_size = s4_fruit_size;
            }

            int s4_fruit_subdivisions = XMLloadint(s, "s4_fruit_subdivisions");
            if (s4_fruit_subdivisions != nullvalue_f) {
                sorghumcanopyparameters.s4_fruit_subdivisions = uint(s4_fruit_subdivisions);
            }
            ...
            int s4_leaf_subdivisions = XMLloadint(s, "s4_leaf_subdivisions");
            if (s4_leaf_subdivisions != nullvalue_f) {
                sorghumcanopyparameters.s4_leaf_subdivisions = uint(s4_leaf_subdivisions);
            }
            ...
            vec2 s5_fruit_size = XMLloadvec2(s, "s5_fruit_size");
            if (s5_fruit_size.x != nullvalue_f && s5_fruit_size.y != nullvalue_f) {
                sorghumcanopyparameters.s5_fruit_size = s5_fruit_size;
            }

            int s5_fruit_subdivisions = XMLloadint(s, "s5_fruit_subdivisions");
            if (s5_fruit_subdivisions != nullvalue_f) {
                sorghumcanopyparameters.s5_fruit_subdivisions = uint(s5_fruit_subdivisions);
            }
            ...
            int s5_leaf_subdivisions = XMLloadint(s, "s5_leaf_subdivisions");
            if (s5_leaf_subdivisions != nullvalue_f) {
                sorghumcanopyparameters.s5_leaf_subdivisions = uint(s5_leaf_subdivisions);
            }
