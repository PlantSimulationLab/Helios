        ...
        if (params.sorghum_stage ==1){
            ...
            context->deletePrimitive(UUID_stem_top);
                ...
                for (float i = 1; i < 4; i++){
                    ...
                    float Nx =  params.s1_leaf_subdivisions ; // subdivisions only taken for the x, y is split into the minimum possible subdivisions (2)
            ...
            for (float i = 1; i < 6; i++){
                ...
                std::vector<uint> UUIDs4;
                float Nx = params.s2_leaf_subdivisions; // subdivisions only taken for the x, y is split into the minimum possible subdivisions (2)
