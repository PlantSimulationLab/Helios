...
public:
    ...
    void setVcmax(float Vcmax_25C, float rate_of_increase_dHa = 65.33f, float optimum_temperature_in_C = 100000.f,
    ...
    void setJmax(float Jmax_25C, float rate_of_increase_dHa = 46.36f, float optimum_temperature_in_C = 100000.f,
                 float rate_of_decrease_dHd = 1000.f) {
    ...
    void setTPU(float TPU_25C, float rate_of_increase_dHa = 46.0f, float optimum_temperature_in_C = 100000.f,
                float rate_of_decrease_dHd = 1000.f) {
    ...
    void setRd(float Rd_25C, float rate_of_increase_dHa = 46.39f, float optimum_temperature_in_C = 100000.f,
               float rate_of_decrease_dHd = 1000.f) {
    ...
    void setQuantumEfficiency_alpha(float alpha_25C, float rate_of_increase_dHa = 0.f,
                                    float optimum_temperature_in_C = 100000.f, float rate_of_decrease_dHd = 1000.f) {
    ...
    void
    setLightResponseCurvature_theta(float theta_25C, float rate_of_increase_dHa = 0.f,
                                    float optimum_temperature_in_C = 100000.f, float rate_of_decrease_dHd = 1000.f) {
...
public:
    ...
    */
    ...
    //! Set the Farquhar-von Caemmerer-Berry model coefficients for a subset of primitives based on their UUIDs
    /**
    * \param[in] "modelcoefficients" Vector of sets of model coefficients.
    * \param[in] "UUIDs" Universal unique identifiers for primitives to be set.
    * \note The model type will be set based on the most recent call to setModelCoefficients().
    */
    void setModelCoefficients(const std::vector<FarquharModelCoefficients> &modelcoefficients,
                              const std::vector<uint> &UUIDs);

    void setModelCoefficients(std::string species);

    void setModelCoefficients(std::string species, const std::vector<uint> &UUIDs);

    FarquharModelCoefficients getModelCoefficients(std::string species);
