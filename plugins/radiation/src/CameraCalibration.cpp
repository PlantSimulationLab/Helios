...
double CameraCalibration::deltaE2000(const LabColor &lab1, const LabColor &lab2) const {
    ...
    // Calculate T
    double T = 1.0 - 0.17 * cos((h_bar_prime - 30) * M_PI / 180.0) +
                     0.24 * cos(2 * h_bar_prime * M_PI / 180.0) +
                     0.32 * cos((3 * h_bar_prime + 6) * M_PI / 180.0) -
                     0.20 * cos((4 * h_bar_prime - 63) * M_PI / 180.0);
