...
RadiationModel::RadiationModel(helios::Context *context_a) {
    ...
    spectral_library_files.push_back(helios::resolveSpectraPath("camera_spectral_library.xml").string());
    spectral_library_files.push_back(helios::resolveSpectraPath("light_spectral_library.xml").string());
    spectral_library_files.push_back(helios::resolveSpectraPath("soil_surface_spectral_library.xml").string());
    spectral_library_files.push_back(helios::resolveSpectraPath("leaf_surface_spectral_library.xml").string());
    spectral_library_files.push_back(helios::resolveSpectraPath("bark_surface_spectral_library.xml").string());
    spectral_library_files.push_back(helios::resolveSpectraPath("fruit_surface_spectral_library.xml").string());
    spectral_library_files.push_back(helios::resolveSpectraPath("solar_spectrum_ASTMG173.xml").string());
    spectral_library_files.push_back(helios::resolveSpectraPath("color_board/Calibrite_ColorChecker_Classic_colorboard.xml").string());
    spectral_library_files.push_back(helios::resolveSpectraPath("color_board/DGK_DKK_colorboard.xml").string());
...
void RadiationModel::buildLightModelGeometry(uint sourceID) {
    ...
    if (source.source_type == RADIATION_SOURCE_TYPE_SPHERE) {
        source_model_UUIDs[sourceID] = context->loadOBJ(helios::resolveModelPath("SphereLightSource.obj").string().c_str(), true);
    } else if (source.source_type == RADIATION_SOURCE_TYPE_SUN_SPHERE) {
        source_model_UUIDs[sourceID] = context->loadOBJ(helios::resolveModelPath("SphereLightSource.obj").string().c_str(), true);
    } else if (source.source_type == RADIATION_SOURCE_TYPE_DISK) {
        source_model_UUIDs[sourceID] = context->loadOBJ(helios::resolveModelPath("DiskLightSource.obj").string().c_str(), true);
        ...
        std::vector<uint> UUIDs_arrow = context->loadOBJ(helios::resolveModelPath("Arrow.obj").string().c_str(), true);
        ...
        source_model_UUIDs[sourceID] = context->loadOBJ(helios::resolveModelPath("RectangularLightSource.obj").string().c_str(), true);
...
void RadiationModel::buildCameraModelGeometry(const std::string &cameralabel) {
    ...
    camera_model_UUIDs[cameralabel] = context->loadOBJ(helios::resolveModelPath("Camera.obj").string().c_str(), true);
