 ...
 */
RTresult RTAPI rtuTraversalCreate(RTUtraversal* traversal, RTUquerytype query_type, RTUrayformat ray_format,
                                  RTUtriformat tri_format, unsigned int outputs, unsigned int options,
                                  RTcontext context);
 ...
 */
RTresult RTAPI rtuTraversalSetMesh(RTUtraversal traversal, unsigned int num_verts, const float* verts,
                                   unsigned int num_tris, const unsigned* indices);
