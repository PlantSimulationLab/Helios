...
#define OPTIX_PRIME_VERSION                               \
    40002 /* major =  OPTIX_PRIME_VERSION/10000,        * \
...
/** Opaque type.  Note that the *_api type should never be used directly. Only the typedef target name will be
 ...
 *
 */
RTPresult RTPAPI rtpContextSetCudaDeviceNumbers(RTPcontext context, unsigned deviceCount,
 ...
 * Example Usage:
 ...
 @endcode
*/
RTPresult RTPAPI rtpBufferDescCreate(RTPcontext context, RTPbufferformat format, RTPbuffertype type, void* buffer,
                                     /*out*/ RTPbufferdesc* desc);
 ...
 * @param[in] ptr        Pointer to where the value of the attribute will be copied from. This must point to at least \a
