 ...
 */
RTresult RTAPI rtContextLaunch2D(RTcontext context, unsigned int entry_point_index, RTsize image_width,
                                 RTsize image_height);
/**
 * @ingroup rtContextLaunch
 * @param[in]   context                                    The context to be executed
 ...
 */
RTresult RTAPI rtContextLaunch3D(RTcontext context, unsigned int entry_point_index, RTsize image_width,
                                 RTsize image_height, RTsize image_depth);
