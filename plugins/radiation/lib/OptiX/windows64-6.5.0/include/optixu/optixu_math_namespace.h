...
OPTIXU_INLINE float fminf(const float a, const float b) { return a < b ? a : b; }

OPTIXU_INLINE float fmaxf(const float a, const float b) { return a > b ? a : b; }
...
#endif
OPTIXU_INLINE int max(int a, int b) { return a > b ? a : b; }

OPTIXU_INLINE int min(int a, int b) { return a < b ? a : b; }

OPTIXU_INLINE long long max(long long a, long long b) { return a > b ? a : b; }

OPTIXU_INLINE long long min(long long a, long long b) { return a < b ? a : b; }

OPTIXU_INLINE unsigned int max(unsigned int a, unsigned int b) { return a > b ? a : b; }

OPTIXU_INLINE unsigned int min(unsigned int a, unsigned int b) { return a < b ? a : b; }

OPTIXU_INLINE unsigned long long max(unsigned long long a, unsigned long long b) { return a > b ? a : b; }

OPTIXU_INLINE unsigned long long min(unsigned long long a, unsigned long long b) { return a < b ? a : b; }
#endif
...
/** lerp */
OPTIXU_INLINE RT_HOSTDEVICE float lerp(const float a, const float b, const float t) { return a + t * (b - a); }
...
/** clamp */
OPTIXU_INLINE RT_HOSTDEVICE float clamp(const float f, const float a, const float b) { return fmaxf(a, fminf(f, b)); }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE float getByIndex(const float1& v, int i) { return ((float*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(float1& v, int i, float x) { ((float*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE float2 make_float2(const float s) { return make_float2(s, s); }
OPTIXU_INLINE RT_HOSTDEVICE float2 make_float2(const int2& a) { return make_float2(float(a.x), float(a.y)); }
OPTIXU_INLINE RT_HOSTDEVICE float2 make_float2(const uint2& a) { return make_float2(float(a.x), float(a.y)); }
/** @} */

/** negate */
OPTIXU_INLINE RT_HOSTDEVICE float2 operator-(const float2& a) { return make_float2(-a.x, -a.y); }
...
OPTIXU_INLINE RT_HOSTDEVICE float fminf(const float2& a) { return fminf(a.x, a.y); }
/** @} */
...
OPTIXU_INLINE RT_HOSTDEVICE float fmaxf(const float2& a) { return fmaxf(a.x, a.y); }
/** @} */
...
OPTIXU_INLINE RT_HOSTDEVICE float2 operator+(const float2& a, const float b) { return make_float2(a.x + b, a.y + b); }
OPTIXU_INLINE RT_HOSTDEVICE float2 operator+(const float a, const float2& b) { return make_float2(a + b.x, a + b.y); }
...
OPTIXU_INLINE RT_HOSTDEVICE float2 operator*(const float2& a, const float s) { return make_float2(a.x * s, a.y * s); }
OPTIXU_INLINE RT_HOSTDEVICE float2 operator*(const float s, const float2& a) { return make_float2(a.x * s, a.y * s); }
...
OPTIXU_INLINE RT_HOSTDEVICE float2 operator/(const float s, const float2& a) { return make_float2(s / a.x, s / a.y); }
OPTIXU_INLINE RT_HOSTDEVICE void operator/=(float2& a, const float s) {
    float inv = 1.0f / s;
    a *= inv;
}
...
/** lerp */
OPTIXU_INLINE RT_HOSTDEVICE float2 lerp(const float2& a, const float2& b, const float t) { return a + t * (b - a); }
...
/** dot product */
OPTIXU_INLINE RT_HOSTDEVICE float dot(const float2& a, const float2& b) { return a.x * b.x + a.y * b.y; }

/** length */
OPTIXU_INLINE RT_HOSTDEVICE float length(const float2& v) { return sqrtf(dot(v, v)); }
...
/** floor */
OPTIXU_INLINE RT_HOSTDEVICE float2 floor(const float2& v) { return make_float2(::floorf(v.x), ::floorf(v.y)); }

/** reflect */
OPTIXU_INLINE RT_HOSTDEVICE float2 reflect(const float2& i, const float2& n) { return i - 2.0f * n * dot(n, i); }
...
/** exp */
OPTIXU_INLINE RT_HOSTDEVICE float2 expf(const float2& v) { return make_float2(::expf(v.x), ::expf(v.y)); }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE float getByIndex(const float2& v, int i) { return ((float*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(float2& v, int i, float x) { ((float*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE float3 make_float3(const float s) { return make_float3(s, s, s); }
OPTIXU_INLINE RT_HOSTDEVICE float3 make_float3(const float2& a) { return make_float3(a.x, a.y, 0.0f); }
...
/** negate */
OPTIXU_INLINE RT_HOSTDEVICE float3 operator-(const float3& a) { return make_float3(-a.x, -a.y, -a.z); }
...
OPTIXU_INLINE RT_HOSTDEVICE float fminf(const float3& a) { return fminf(fminf(a.x, a.y), a.z); }
/** @} */
...
OPTIXU_INLINE RT_HOSTDEVICE float fmaxf(const float3& a) { return fmaxf(fmaxf(a.x, a.y), a.z); }
/** @} */
...
/** lerp */
OPTIXU_INLINE RT_HOSTDEVICE float3 lerp(const float3& a, const float3& b, const float t) { return a + t * (b - a); }
...
/** dot product */
OPTIXU_INLINE RT_HOSTDEVICE float dot(const float3& a, const float3& b) { return a.x * b.x + a.y * b.y + a.z * b.z; }
...
/** length */
OPTIXU_INLINE RT_HOSTDEVICE float length(const float3& v) { return sqrtf(dot(v, v)); }
...
/** reflect */
OPTIXU_INLINE RT_HOSTDEVICE float3 reflect(const float3& i, const float3& n) { return i - 2.0f * n * dot(n, i); }
...
/** exp */
OPTIXU_INLINE RT_HOSTDEVICE float3 expf(const float3& v) { return make_float3(::expf(v.x), ::expf(v.y), ::expf(v.z)); }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE float getByIndex(const float3& v, int i) { return ((float*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(float3& v, int i, float x) { ((float*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE float4 make_float4(const float s) { return make_float4(s, s, s, s); }
OPTIXU_INLINE RT_HOSTDEVICE float4 make_float4(const float3& a) { return make_float4(a.x, a.y, a.z, 0.0f); }
...
/** negate */
OPTIXU_INLINE RT_HOSTDEVICE float4 operator-(const float4& a) { return make_float4(-a.x, -a.y, -a.z, -a.w); }
...
OPTIXU_INLINE RT_HOSTDEVICE float fminf(const float4& a) { return fminf(fminf(a.x, a.y), fminf(a.z, a.w)); }
/** @} */
...
OPTIXU_INLINE RT_HOSTDEVICE float fmaxf(const float4& a) { return fmaxf(fmaxf(a.x, a.y), fmaxf(a.z, a.w)); }
/** @} */
...
/** lerp */
OPTIXU_INLINE RT_HOSTDEVICE float4 lerp(const float4& a, const float4& b, const float t) { return a + t * (b - a); }
...
/** length */
OPTIXU_INLINE RT_HOSTDEVICE float length(const float4& r) { return sqrtf(dot(r, r)); }
...
/** reflect */
OPTIXU_INLINE RT_HOSTDEVICE float4 reflect(const float4& i, const float4& n) { return i - 2.0f * n * dot(n, i); }
...
/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE float getByIndex(const float4& v, int i) { return ((float*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(float4& v, int i, float x) { ((float*)(&v))[i] = x; }

/* int functions */
/******************************************************************************/

/** clamp */
OPTIXU_INLINE RT_HOSTDEVICE int clamp(const int f, const int a, const int b) { return max(a, min(f, b)); }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE int getByIndex(const int1& v, int i) { return ((int*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(int1& v, int i, int x) { ((int*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE int2 make_int2(const int s) { return make_int2(s, s); }
OPTIXU_INLINE RT_HOSTDEVICE int2 make_int2(const float2& a) { return make_int2(int(a.x), int(a.y)); }
/** @} */

/** negate */
OPTIXU_INLINE RT_HOSTDEVICE int2 operator-(const int2& a) { return make_int2(-a.x, -a.y); }

/** min */
OPTIXU_INLINE RT_HOSTDEVICE int2 min(const int2& a, const int2& b) { return make_int2(min(a.x, b.x), min(a.y, b.y)); }

/** max */
OPTIXU_INLINE RT_HOSTDEVICE int2 max(const int2& a, const int2& b) { return make_int2(max(a.x, b.x), max(a.y, b.y)); }

/** add
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE int2 operator+(const int2& a, const int2& b) { return make_int2(a.x + b.x, a.y + b.y); }
 ...
 */
OPTIXU_INLINE RT_HOSTDEVICE int2 operator-(const int2& a, const int2& b) { return make_int2(a.x - b.x, a.y - b.y); }
OPTIXU_INLINE RT_HOSTDEVICE int2 operator-(const int2& a, const int b) { return make_int2(a.x - b, a.y - b); }
OPTIXU_INLINE RT_HOSTDEVICE void operator-=(int2& a, const int2& b) {
    a.x -= b.x;
    a.y -= b.y;
}
 ...
 */
OPTIXU_INLINE RT_HOSTDEVICE int2 operator*(const int2& a, const int2& b) { return make_int2(a.x * b.x, a.y * b.y); }
OPTIXU_INLINE RT_HOSTDEVICE int2 operator*(const int2& a, const int s) { return make_int2(a.x * s, a.y * s); }
OPTIXU_INLINE RT_HOSTDEVICE int2 operator*(const int s, const int2& a) { return make_int2(a.x * s, a.y * s); }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE bool operator==(const int2& a, const int2& b) { return a.x == b.x && a.y == b.y; }

OPTIXU_INLINE RT_HOSTDEVICE bool operator!=(const int2& a, const int2& b) { return a.x != b.x || a.y != b.y; }
/** @} */

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE int getByIndex(const int2& v, int i) { return ((int*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(int2& v, int i, int x) { ((int*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE int3 make_int3(const int s) { return make_int3(s, s, s); }
OPTIXU_INLINE RT_HOSTDEVICE int3 make_int3(const float3& a) { return make_int3(int(a.x), int(a.y), int(a.z)); }
/** @} */

/** negate */
OPTIXU_INLINE RT_HOSTDEVICE int3 operator-(const int3& a) { return make_int3(-a.x, -a.y, -a.z); }
...
OPTIXU_INLINE RT_HOSTDEVICE int3 operator*(const int3& a, const int s) { return make_int3(a.x * s, a.y * s, a.z * s); }
OPTIXU_INLINE RT_HOSTDEVICE int3 operator*(const int s, const int3& a) { return make_int3(a.x * s, a.y * s, a.z * s); }
...
OPTIXU_INLINE RT_HOSTDEVICE int3 operator/(const int3& a, const int s) { return make_int3(a.x / s, a.y / s, a.z / s); }
OPTIXU_INLINE RT_HOSTDEVICE int3 operator/(const int s, const int3& a) { return make_int3(s / a.x, s / a.y, s / a.z); }
OPTIXU_INLINE RT_HOSTDEVICE void operator/=(int3& a, const int s) {
    a.x /= s;
    a.y /= s;
    a.z /= s;
...
/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE int getByIndex(const int3& v, int i) { return ((int*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(int3& v, int i, int x) { ((int*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE int4 make_int4(const int s) { return make_int4(s, s, s, s); }
...
/** negate */
OPTIXU_INLINE RT_HOSTDEVICE int4 operator-(const int4& a) { return make_int4(-a.x, -a.y, -a.z, -a.w); }
...
/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE int getByIndex(const int4& v, int i) { return ((int*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(int4& v, int i, int x) { ((int*)(&v))[i] = x; }
...
/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE unsigned int getByIndex(const uint1& v, unsigned int i) { return ((unsigned int*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(uint1& v, int i, unsigned int x) { ((unsigned int*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE uint2 make_uint2(const unsigned int s) { return make_uint2(s, s); }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE uint2 operator+(const uint2& a, const uint2& b) { return make_uint2(a.x + b.x, a.y + b.y); }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE bool operator==(const uint2& a, const uint2& b) { return a.x == b.x && a.y == b.y; }

OPTIXU_INLINE RT_HOSTDEVICE bool operator!=(const uint2& a, const uint2& b) { return a.x != b.x || a.y != b.y; }
/** @} */

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE unsigned int getByIndex(const uint2& v, unsigned int i) { return ((unsigned int*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(uint2& v, int i, unsigned int x) { ((unsigned int*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE uint3 make_uint3(const unsigned int s) { return make_uint3(s, s, s); }
...
/** If used on the device, this could place the the 'v' in local memory
 */
OPTIXU_INLINE RT_HOSTDEVICE unsigned int getByIndex(const uint3& v, unsigned int i) { return ((unsigned int*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory
 */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(uint3& v, int i, unsigned int x) { ((unsigned int*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE uint4 make_uint4(const unsigned int s) { return make_uint4(s, s, s, s); }
...
/** If used on the device, this could place the the 'v' in local memory
 */
OPTIXU_INLINE RT_HOSTDEVICE unsigned int getByIndex(const uint4& v, unsigned int i) { return ((unsigned int*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory
 */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(uint4& v, int i, unsigned int x) { ((unsigned int*)(&v))[i] = x; }
...
/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE long long getByIndex(const longlong1& v, int i) { return ((long long*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(longlong1& v, int i, long long x) { ((long long*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE longlong2 make_longlong2(const long long s) { return make_longlong2(s, s); }
OPTIXU_INLINE RT_HOSTDEVICE longlong2 make_longlong2(const float2& a) { return make_longlong2(int(a.x), int(a.y)); }
/** @} */

/** negate */
OPTIXU_INLINE RT_HOSTDEVICE longlong2 operator-(const longlong2& a) { return make_longlong2(-a.x, -a.y); }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE bool operator==(const longlong2& a, const longlong2& b) { return a.x == b.x && a.y == b.y; }

OPTIXU_INLINE RT_HOSTDEVICE bool operator!=(const longlong2& a, const longlong2& b) { return a.x != b.x || a.y != b.y; }
/** @} */

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE long long getByIndex(const longlong2& v, int i) { return ((long long*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(longlong2& v, int i, long long x) { ((long long*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE longlong3 make_longlong3(const long long s) { return make_longlong3(s, s, s); }
...
/** negate */
OPTIXU_INLINE RT_HOSTDEVICE longlong3 operator-(const longlong3& a) { return make_longlong3(-a.x, -a.y, -a.z); }
...
/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE long long getByIndex(const longlong3& v, int i) { return ((long long*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(longlong3& v, int i, int x) { ((long long*)(&v))[i] = x; }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE longlong4 make_longlong4(const long long s) { return make_longlong4(s, s, s, s); }
...
/** negate */
OPTIXU_INLINE RT_HOSTDEVICE longlong4 operator-(const longlong4& a) { return make_longlong4(-a.x, -a.y, -a.z, -a.w); }
...
/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE long long getByIndex(const longlong4& v, int i) { return ((long long*)(&v))[i]; }

/** If used on the device, this could place the the 'v' in local memory */
OPTIXU_INLINE RT_HOSTDEVICE void setByIndex(longlong4& v, int i, long long x) { ((long long*)(&v))[i] = x; }

/* ulonglong functions */
/******************************************************************************/

/** clamp */
OPTIXU_INLINE RT_HOSTDEVICE unsigned long long clamp(const unsigned long long f, const unsigned long long a,
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE ulonglong2 make_ulonglong2(const unsigned long long s) { return make_ulonglong2(s, s); }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE ulonglong2 clamp(const ulonglong2& v, const unsigned long long a,
                                             const unsigned long long b) {
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE ulonglong3 make_ulonglong3(const unsigned long long s) { return make_ulonglong3(s, s, s); }
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE ulonglong3 clamp(const ulonglong3& v, const unsigned long long a,
                                             const unsigned long long b) {
 ...
 * @{
 */
OPTIXU_INLINE RT_HOSTDEVICE ulonglong4 clamp(const ulonglong4& v, const unsigned long long a,
                                             const unsigned long long b) {
...
OPTIXU_INLINE RT_HOSTDEVICE ulonglong3 make_ulonglong3(const ulonglong4& v0) {
...
OPTIXU_INLINE RT_HOSTDEVICE longlong3 make_longlong3(const long long v0, const longlong2& v1) {
    return make_longlong3(v0, v1.x, v1.y);
}
OPTIXU_INLINE RT_HOSTDEVICE longlong3 make_longlong3(const longlong2& v0, const long long v1) {
    return make_longlong3(v0.x, v0.y, v1);
}
OPTIXU_INLINE RT_HOSTDEVICE longlong4 make_longlong4(const long long v0, const long long v1, const longlong2& v2) {
    return make_longlong4(v0, v1, v2.x, v2.y);
}
OPTIXU_INLINE RT_HOSTDEVICE longlong4 make_longlong4(const long long v0, const longlong2& v1, const long long v2) {
    return make_longlong4(v0, v1.x, v1.y, v2);
}
OPTIXU_INLINE RT_HOSTDEVICE longlong4 make_longlong4(const longlong2& v0, const long long v1, const long long v2) {
    return make_longlong4(v0.x, v0.y, v1, v2);
}
OPTIXU_INLINE RT_HOSTDEVICE longlong4 make_longlong4(const long long v0, const longlong3& v1) {
    return make_longlong4(v0, v1.x, v1.y, v1.z);
}
OPTIXU_INLINE RT_HOSTDEVICE longlong4 make_longlong4(const longlong3& v0, const long long v1) {
    return make_longlong4(v0.x, v0.y, v0.z, v1);
}
OPTIXU_INLINE RT_HOSTDEVICE longlong4 make_longlong4(const longlong2& v0, const longlong2& v1) {
    return make_longlong4(v0.x, v0.y, v1.x, v1.y);
}
OPTIXU_INLINE RT_HOSTDEVICE ulonglong3 make_ulonglong3(const unsigned long long v0, const ulonglong2& v1) {
    return make_ulonglong3(v0, v1.x, v1.y);
}
OPTIXU_INLINE RT_HOSTDEVICE ulonglong3 make_ulonglong3(const ulonglong2& v0, const unsigned long long v1) {
    return make_ulonglong3(v0.x, v0.y, v1);
}
OPTIXU_INLINE RT_HOSTDEVICE ulonglong4 make_ulonglong4(const unsigned long long v0, const unsigned long long v1,
                                                       const ulonglong2& v2) {
    return make_ulonglong4(v0, v1, v2.x, v2.y);
}
OPTIXU_INLINE RT_HOSTDEVICE ulonglong4 make_ulonglong4(const unsigned long long v0, const ulonglong2& v1,
                                                       const unsigned long long v2) {
    return make_ulonglong4(v0, v1.x, v1.y, v2);
}
OPTIXU_INLINE RT_HOSTDEVICE ulonglong4 make_ulonglong4(const ulonglong2& v0, const unsigned long long v1,
                                                       const unsigned long long v2) {
    return make_ulonglong4(v0.x, v0.y, v1, v2);
}
OPTIXU_INLINE RT_HOSTDEVICE ulonglong4 make_ulonglong4(const unsigned long long v0, const ulonglong3& v1) {
    return make_ulonglong4(v0, v1.x, v1.y, v1.z);
}
OPTIXU_INLINE RT_HOSTDEVICE ulonglong4 make_ulonglong4(const ulonglong3& v0, const unsigned long long v1) {
    return make_ulonglong4(v0.x, v0.y, v0.z, v1);
}
OPTIXU_INLINE RT_HOSTDEVICE ulonglong4 make_ulonglong4(const ulonglong2& v0, const ulonglong2& v1) {
 ...
 */
OPTIXU_INLINE RT_HOSTDEVICE bool intersect_triangle_branchless(const Ray& ray, const float3& p0, const float3& p1,
                                                               const float3& p2, float3& n, float& t, float& beta,
                                                               float& gamma) {
 ...
 */
OPTIXU_INLINE RT_HOSTDEVICE bool intersect_triangle_earlyexit(const Ray& ray, const float3& p0, const float3& p1,
                                                              const float3& p2, float3& n, float& t, float& beta,
                                                              float& gamma) {
    float3 e0 = p1 - p0;
    float3 e1 = p0 - p2;
...
OPTIXU_INLINE RT_HOSTDEVICE bool intersect_triangle(const Ray& ray, const float3& p0, const float3& p1,
                                                    const float3& p2, float3& n, float& t, float& beta, float& gamma) {
...
OPTIXU_INLINE RT_HOSTDEVICE float3 fresnel_schlick(const float cos_theta, const float exponent, const float3& minimum,
