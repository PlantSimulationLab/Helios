 ...
 * - \b rtCurrentRay - The currently active ray, valid only when a call to @ref rtTrace is active.  Type must be \a
 * optix::Ray and is read-only.
...
static inline __device__ void rtTrace(rtObject topNode, optix::Ray ray, T& prd) {
    optix::rt_trace(*(unsigned int*)&topNode, ray.origin, ray.direction, ray.ray_type, ray.tmin, ray.tmax, &prd,
                    sizeof(T));
}
...
static inline __device__ void rtPrintExceptionDetails() {
    ...
    if (code == RT_EXCEPTION_STACK_OVERFLOW) {
        ...
        rtPrintf(
            ...
            rti_internal_register::reg_rayIndex_x, rti_internal_register::reg_rayIndex_y,
            rti_internal_register::reg_rayIndex_z, rti_internal_register::reg_exception_64_detail0,
            rti_internal_register::reg_exception_detail0, rti_internal_register::reg_exception_64_detail1,
        ...
        rtPrintf(
            ...
            rti_internal_register::reg_rayIndex_x, rti_internal_register::reg_rayIndex_y,
            rti_internal_register::reg_rayIndex_z, rti_internal_register::reg_exception_detail0,
            rti_internal_register::reg_exception_detail1, rti_internal_register::reg_exception_detail2,
            dim > 1 ? rti_internal_register::reg_exception_detail3 : 1,
            dim > 2 ? rti_internal_register::reg_exception_detail4 : 1, rti_internal_register::reg_exception_detail5,
            rti_internal_register::reg_exception_detail6, rti_internal_register::reg_exception_detail7,
        ...
        rtPrintf(
            ...
            "  ray tmax      : %f\n",
            rti_internal_register::reg_rayIndex_x, rti_internal_register::reg_rayIndex_y,
            rti_internal_register::reg_rayIndex_z, __int_as_float(rti_internal_register::reg_exception_detail0),
