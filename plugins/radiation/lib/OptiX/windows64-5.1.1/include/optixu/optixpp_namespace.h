...
class ContextObj : public ScopedObj {
   public:
    ...
    /// @ref rtBufferSetFormat and @ref rtBufferSetSize1DMipmapped.
    ...
    /// Create a mipmapped buffer with given RTbuffertype, RTformat and dimension.  See @ref rtBufferCreate,
    /// @ref rtBufferSetFormat and @ref rtBufferSetSize2DMipmapped.
    ...
    /// Create a mipmapped buffer with given RTbuffertype, RTformat and dimension.  See @ref rtBufferCreate,
    /// @ref rtBufferSetFormat and @ref rtBufferSetSize3DMipmapped.
...
class AccelerationObj : public DestroyableObj {
   public:
    ...
    /// @{
    /// <B>Deprecated in OptiX 4.0</B> Query the size of the marshalled acceleration data.  See @ref
    ...
    /// <B>Deprecated in OptiX 4.0</B> Specify the acceleration structure via marshalled acceleration data.  See @ref
...
class TextureSamplerObj : public DestroyableObj {
   public:
    ...
    /// Set minimum and maxnimum mipmap levels for this sampler.  See @ref rtTextureSamplerSetMipLevelClamp.
    void setMipLevelClamp(float minLevel, float maxLevel);
    /// Query minimum and maxnimum mipmap levels for this sampler.  See @ref rtTextureSamplerGetMipLevelClamp.
...
inline RemoteDevice RemoteDeviceObj::create(const std::string& url, const std::string& username,
...
inline void RemoteDeviceObj::release() { checkErrorNoGetContext(rtRemoteDeviceRelease(m_rdev)); }
...
inline std::string RemoteDeviceObj::getConfiguration(unsigned int config_index) {
    char tmp[256];
    checkErrorNoGetContext(rtRemoteDeviceGetAttribute(
        m_rdev, (RTremotedeviceattribute)(RT_REMOTEDEVICE_ATTRIBUTE_CONFIGURATIONS + config_index), 256, tmp));
    return std::string(tmp);
}

inline RTremotedevice RemoteDeviceObj::get() { return m_rdev; }
