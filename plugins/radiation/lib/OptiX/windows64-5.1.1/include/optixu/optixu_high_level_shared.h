...
__host__ __device__ __inline__ int rthVertexBufferFormatUsesAttribute(unsigned int attribute_offset,
                                                                      unsigned int attribute_stride) {
    return attribute_offset != RTH_UNUSED && attribute_stride != RTH_UNUSED;
}

__host__ __device__ __inline__ int rthVertexBufferFormatUsesColor(RTHvertexBufferFormat format) {
    return rthVertexBufferFormatUsesAttribute(format.color_offset, format.color_stride);
}

__host__ __device__ __inline__ int rthVertexBufferFormatUsesNormal(RTHvertexBufferFormat format) {
    return rthVertexBufferFormatUsesAttribute(format.normal_offset, format.normal_stride);
}

__host__ __device__ __inline__ int rthVertexBufferFormatUsesTexcoords(RTHvertexBufferFormat format) {
