...
RT_SIZET_INLINE RT_HOSTDEVICE size_t4 make_size_t4(unsigned int s) { return make_size_t4(s, s, s, s); }
RT_SIZET_INLINE RT_HOSTDEVICE size_t3 make_size_t3(unsigned int s) { return make_size_t3(s, s, s); }
RT_SIZET_INLINE RT_HOSTDEVICE size_t2 make_size_t2(unsigned int s) { return make_size_t2(s, s); }
RT_SIZET_INLINE RT_HOSTDEVICE size_t3 make_size_t3(size_t4 st) { return make_size_t3(st.x, st.y, st.z); }
RT_SIZET_INLINE RT_HOSTDEVICE size_t2 make_size_t2(size_t4 st) { return make_size_t2(st.x, st.y); }
RT_SIZET_INLINE RT_HOSTDEVICE size_t make_size_t(size_t4 v0) { return (size_t)v0.x; }

RT_SIZET_INLINE RT_HOSTDEVICE size_t4 make_size_t4(uint4 s) { return make_size_t4(s.x, s.y, s.z, s.w); }
