...
class Handle {
   public:
    ...
    template <class U>
    Handle(const Handle<U>& copy) : ptr(copy.ptr) {
        ref();
    }
   ...
   private:
    ...
    inline void unref() {
        if (ptr && ptr->removeReference() == 0) delete ptr;
    }
    T* ptr;
};
...
class VariableObj : public APIObj {
   public:
    ...
    void setULongLong(unsigned long long u1, unsigned long long u2, unsigned long long u3, unsigned long long u4);
    ...
    void getULongLong(unsigned long long& ull1, unsigned long long& ull2, unsigned long long& ull3) const;
    void getULongLong(unsigned long long& ull1, unsigned long long& ull2, unsigned long long& ull3,
                      unsigned long long& ull4) const;
...
Handle<VariableObj> Handle<T>::operator[](const std::string& varname) {
    ...
    if (v.operator->() == 0) v = ptr->declareVariable(varname);
    return v;
}
...
class ContextObj : public ScopedObj {
   public:
    ...
    /// Call rtDeviceGetAttribute and return the list of ordinals compatible with the device; a device is always
    ...
    Buffer createMipmappedBuffer(unsigned int type, RTformat format, RTsize width, RTsize height, RTsize depth,
                                 unsigned int levels);
    ...
    /// @ref rtBufferSetFormat,  @ref rtBufferSetMipLevelCount, and @ref rtBufferSetSize3D.
    Buffer create2DLayeredBuffer(unsigned int type, RTformat format, RTsize width, RTsize height, RTsize layers,
                                 unsigned int levels);
    ...
    /// Create a cube layered mipmapped buffer with given RTbuffertype, RTformat and dimension.  See @ref
    /// rtBufferCreate,
    /// @ref rtBufferSetFormat,  @ref rtBufferSetMipLevelCount, and @ref rtBufferSetSize3D.
    Buffer createCubeLayeredBuffer(unsigned int type, RTformat format, RTsize width, RTsize height, RTsize faces,
                                   unsigned int levels);
    ...
    /// Create a demand loaded buffer from a callback with given format.  See @ref rtBufferCreateFromCallback and @ref
    /// rtBufferSetForamt.
    ...
    void launchProgressive(unsigned int entry_point_index, RTsize image_width, RTsize image_height,
...
class AccelerationObj : public DestroyableObj {
   public:
    ...
    /// <B>Deprecated in OptiX 4.0</B> Specify the acceleration structure traverser.  See @ref
    ...
    /// @{
    /// <B>Deprecated in OptiX 4.0</B> Query the size of the marshaled acceleration data.  See @ref
    ...
    /// <B>Deprecated in OptiX 4.0</B> Specify the acceleration structure via marshaled acceleration data.  See @ref
...
class GeometryInstanceObj : public ScopedObj {
   public:
    ...
    /// Set the GeometryTriangles object associated with this instance.  See @ref
    /// rtGeometryInstanceSetGeometryTriangles.
    void setGeometryTriangles(GeometryTriangles geometry);
    /// Get the GeometryTriangles object associated with this instance.  See @ref
    /// rtGeometryInstanceGetGeometryTriangles.
...
class GeometryTrianglesObj : public DestroyableObj {
   public:
    ...
    void setTriangleIndices(Buffer index_buffer, RTsize index_buffer_byte_offset, RTsize tri_indices_byte_stride,
    ...
    void setVertices(unsigned int num_vertices, Buffer vertex_buffer, RTsize vertex_buffer_byte_offset,
                     RTformat position_format);
    void setVertices(unsigned int num_vertices, Buffer vertex_buffer, RTsize vertex_buffer_byte_offset,
                     RTsize vertex_byte_stride, RTformat position_format);
    ...
    void setMotionVertices(unsigned int num_vertices, Buffer vertex_buffer, RTsize vertex_buffer_byte_offset,
                           RTsize vertex_byte_stride, RTsize vertex_motion_step_byte_stride, RTformat position_format);
    /// See @ref rtGeometryTrianglesSetMotionVerticesMultiBuffer
    template <class BufferIterator>
    void setMotionVerticesMultiBuffer(unsigned int num_vertices, BufferIterator vertex_buffers_begin,
                                      BufferIterator vertex_buffers_end, RTsize vertex_buffer_byte_offset,
                                      RTsize vertex_byte_stride, RTformat position_format);
    /// @}
    ...
    void setMaterialIndices(Buffer material_index_buffer, RTsize material_index_buffer_byte_offset,
                            RTsize material_index_byte_stride, RTformat material_index_format);
...
class MaterialObj : public ScopedObj {
   public:
    ...
    /// @{
    /// Set closest hit program for this material at the given \a ray_type index.  See @ref
    /// rtMaterialSetClosestHitProgram.
    void setClosestHitProgram(unsigned int ray_type_index, Program program);
    /// Get closest hit program for this material at the given \a ray_type index.  See @ref
...
class TextureSamplerObj : public DestroyableObj {
   public:
    ...
    /// @{
    /// <B>Deprecated in OptiX 4.0</B> Set the number of mip levels for this sampler.  See @ref
    /// rtTextureSamplerSetMipLevelCount.
    void setMipLevelCount(unsigned int num_mip_levels);
    /// <B>Deprecated in OptiX 4.0</B> Query the number of mip levels for this sampler.  See @ref
    /// rtTextureSamplerGetMipLevelCount.
    unsigned int getMipLevelCount() const;

    /// <B>Deprecated in OptiX 4.0</B> Set the texture array size for this sampler.  See @ref
    /// rtTextureSamplerSetArraySize
    void setArraySize(unsigned int num_textures_in_array);
    /// <B>Deprecated in OptiX 4.0</B> Query the texture array size for this sampler.  See @ref
    ...
    /// @{
    /// <B>Deprecated in OptiX 4.0</B> Set the underlying buffer used for texture storage. See @ref
    /// rtTextureSamplerSetBuffer.
    void setBuffer(unsigned int texture_array_idx, unsigned int mip_level, Buffer buffer);
    /// <B>Deprecated in OptiX 4.0</B> Get the underlying buffer used for texture storage. See @ref
...
class callableProgramId<ReturnT(Arg0T, Arg1T, Arg2T, Arg3T, Arg4T, Arg5T, Arg6T, Arg7T)>
RT_INTERNAL_CALLABLE_PROGRAM_DEFS();
template <typename ReturnT, typename Arg0T, typename Arg1T, typename Arg2T, typename Arg3T, typename Arg4T,
          typename Arg5T, typename Arg6T, typename Arg7T, typename Arg8T>
class callableProgramId<ReturnT(Arg0T, Arg1T, Arg2T, Arg3T, Arg4T, Arg5T, Arg6T, Arg7T, Arg8T)>
RT_INTERNAL_CALLABLE_PROGRAM_DEFS();
template <typename ReturnT, typename Arg0T, typename Arg1T, typename Arg2T, typename Arg3T, typename Arg4T,
          typename Arg5T, typename Arg6T, typename Arg7T, typename Arg8T, typename Arg9T>
class callableProgramId<ReturnT(Arg0T, Arg1T, Arg2T, Arg3T, Arg4T, Arg5T, Arg6T, Arg7T, Arg8T, Arg9T)>
RT_INTERNAL_CALLABLE_PROGRAM_DEFS();
...
class markedCallableProgramId {
   ...
   public:
    markedCallableProgramId() {
        Fail<true> rtMarkedCallableProgramId_is_only_valid_in_device_code_use_rtCallableProgramId_instead;
    }
    markedCallableProgramId(int) {
        Fail<true> rtMarkedCallableProgramId_is_only_valid_in_device_code_use_rtCallableProgramId_instead;
    }
};
...
inline Context ContextObj::getContext() const { return Context::take(m_context); }

inline void ContextObj::checkError(RTresult code) const {
    if (code != RT_SUCCESS && code != RT_TIMEOUT_CALLBACK) throw Exception::makeException(code, m_context);
}

inline unsigned int ContextObj::getDeviceCount() {
    unsigned int count;
    if (RTresult code = rtDeviceGetDeviceCount(&count)) throw Exception::makeException(code, 0);
...
inline std::string ContextObj::getDeviceName(int ordinal) {
    ...
    if (RTresult code = rtDeviceGetAttribute(ordinal, RT_DEVICE_ATTRIBUTE_NAME, max_string_size, name))
...
inline std::string ContextObj::getDevicePCIBusId(int ordinal) {
    ...
    if (RTresult code = rtDeviceGetAttribute(ordinal, RT_DEVICE_ATTRIBUTE_PCI_BUS_ID, max_string_size, pciBusId))
        throw Exception::makeException(code, 0);
...
inline void ContextObj::getDeviceAttribute(int ordinal, RTdeviceattribute attrib, RTsize size, void* p) {
    if (RTresult code = rtDeviceGetAttribute(ordinal, attrib, size, p)) throw Exception::makeException(code, 0);
}

inline Context ContextObj::create() {
    RTcontext c;
    if (RTresult code = rtContextCreate(&c)) throw Exception::makeException(code, 0);
...
inline void ContextObj::validate() { checkError(rtContextValidate(m_context)); }
...
inline Buffer ContextObj::createMipmappedBuffer(unsigned int type, RTformat format, RTsize width, RTsize height,
                                                unsigned int levels) {
    RTbuffer buffer;
    checkError(rtBufferCreate(m_context, type, &buffer));
    checkError(rtBufferSetFormat(buffer, format));
...
inline Buffer ContextObj::createMipmappedBuffer(unsigned int type, RTformat format, RTsize width, RTsize height,
                                                RTsize depth, unsigned int levels) {
    RTbuffer buffer;
    checkError(rtBufferCreate(m_context, type, &buffer));
    checkError(rtBufferSetFormat(buffer, format));
    checkError(rtBufferSetMipLevelCount(buffer, levels));
...
inline Buffer ContextObj::create1DLayeredBuffer(unsigned int type, RTformat format, RTsize width, RTsize layers,
                                                unsigned int levels) {
    RTbuffer buffer;
...
inline Buffer ContextObj::create2DLayeredBuffer(unsigned int type, RTformat format, RTsize width, RTsize height,
                                                RTsize layers, unsigned int levels) {
    RTbuffer buffer;
    checkError(rtBufferCreate(m_context, type | RT_BUFFER_LAYERED, &buffer));
    checkError(rtBufferSetFormat(buffer, format));
    checkError(rtBufferSetMipLevelCount(buffer, levels));
...
inline Buffer ContextObj::createCubeBuffer(unsigned int type, RTformat format, RTsize width, RTsize height,
                                           unsigned int levels) {
    RTbuffer buffer;
...
inline Buffer ContextObj::createCubeLayeredBuffer(unsigned int type, RTformat format, RTsize width, RTsize height,
                                                  RTsize faces, unsigned int levels) {
    RTbuffer buffer;
...
inline Buffer ContextObj::createBufferFromCallback(unsigned int type, RTbuffercallback callback, void* callbackData,
                                                   RTformat format, RTsize width, RTsize height) {
    RTbuffer buffer;
    checkError(rtBufferCreateFromCallback(m_context, type, callback, callbackData, &buffer));
    checkError(rtBufferSetFormat(buffer, format));
    checkError(rtBufferSetSize2D(buffer, width, height));
...
inline Buffer ContextObj::createBufferFromCallback(unsigned int type, RTbuffercallback callback, void* callbackData,
                                                   RTformat format, RTsize width, RTsize height, RTsize depth) {
    RTbuffer buffer;
    checkError(rtBufferCreateFromCallback(m_context, type, callback, callbackData, &buffer));
    checkError(rtBufferSetFormat(buffer, format));
    checkError(rtBufferSetSize3D(buffer, width, height, depth));
...
GeometryInstance ContextObj::createGeometryInstance(Geometry geometry, Iterator matlbegin, Iterator matlend) {
    ...
    for (Iterator iter = matlbegin; iter != matlend; ++iter) ++count;
    result->setMaterialCount(count);
    unsigned int index = 0;
    for (Iterator iter = matlbegin; iter != matlend; ++iter, ++index) result->setMaterial(index, *iter);
    return result;
}

template <class Iterator>
GeometryInstance ContextObj::createGeometryInstance(GeometryTriangles geometrytriangles, Iterator matlbegin,
                                                    Iterator matlend) {
    GeometryInstance result = createGeometryInstance();
...
inline Group ContextObj::createGroup(Iterator childbegin, Iterator childend) {
    ...
    unsigned int count = 0;
    for (Iterator iter = childbegin; iter != childend; ++iter) ++count;
    result->setChildCount(count);
    unsigned int index = 0;
    for (Iterator iter = childbegin; iter != childend; ++iter, ++index) result->setChild(index, *iter);
    return result;
}
...
inline Program ContextObj::createProgramFromPTXFiles(const std::vector<std::string>& filenames,
...
inline Program ContextObj::createProgramFromPTXFiles(const std::vector<const char*>& filenames,
                                                     const std::string& program_name) {
    RTprogram program;
    unsigned int n = static_cast<unsigned int>(filenames.size());
    checkError(rtProgramCreateFromPTXFiles(m_context, n, const_cast<const char**>(&filenames[0]), program_name.c_str(),
                                           &program));
    return Program::take(program);
}
...
inline Program ContextObj::createProgramFromPTXStrings(const std::vector<std::string>& ptxStrings,
                                                       const std::string& program_name) {
...
inline Program ContextObj::createProgramFromPTXStrings(const std::vector<const char*>& ptxStrings,
                                                       const std::string& program_name) {
    RTprogram program;
    unsigned int n = static_cast<unsigned int>(ptxStrings.size());
    checkError(rtProgramCreateFromPTXStrings(m_context, n, const_cast<const char**>(&ptxStrings[0]),
...
template <class Iterator>
inline void ContextObj::setDevices(Iterator begin, Iterator end) {
...
inline int ContextObj::getCPUNumThreads() const {
    int cpu_num_threads;
    checkError(rtContextGetAttribute(m_context, RT_CONTEXT_ATTRIBUTE_CPU_NUM_THREADS, sizeof(cpu_num_threads),
                                     &cpu_num_threads));
...
inline bool ContextObj::getPreferFastRecompiles() const {
    int enabled;
    checkError(
        rtContextGetAttribute(m_context, RT_CONTEXT_ATTRIBUTE_PREFER_FAST_RECOMPILES, sizeof(enabled), &enabled));
    return enabled != 0;
}
...
inline bool ContextObj::getForceInlineUserFunctions() const {
    int enabled;
    checkError(
        rtContextGetAttribute(m_context, RT_CONTEXT_ATTRIBUTE_FORCE_INLINE_USER_FUNCTIONS, sizeof(enabled), &enabled));
    return enabled != 0;
}

inline int ContextObj::getGPUPagingActive() const {
    int gpu_paging_active;
    checkError(rtContextGetAttribute(m_context, RT_CONTEXT_ATTRIBUTE_GPU_PAGING_ACTIVE, sizeof(gpu_paging_active),
                                     &gpu_paging_active));
...
inline int ContextObj::getGPUPagingForcedOff() const {
    ...
    checkError(rtContextGetAttribute(m_context, RT_CONTEXT_ATTRIBUTE_GPU_PAGING_FORCED_OFF,
                                     sizeof(gpu_paging_forced_off), &gpu_paging_forced_off));
    return gpu_paging_forced_off;
}

inline RTsize ContextObj::getAvailableDeviceMemory(int ordinal) const {
    RTsize free_mem;
    checkError(rtContextGetAttribute(
        m_context, static_cast<RTcontextattribute>(RT_CONTEXT_ATTRIBUTE_AVAILABLE_DEVICE_MEMORY + ordinal),
        sizeof(free_mem), &free_mem));
    return free_mem;
}

inline void ContextObj::setCPUNumThreads(int cpu_num_threads) {
    checkError(rtContextSetAttribute(m_context, RT_CONTEXT_ATTRIBUTE_CPU_NUM_THREADS, sizeof(cpu_num_threads),
                                     &cpu_num_threads));
}
...
inline void ContextObj::setForceInlineUserFunctions(bool enabled) {
    int value = enabled;
    checkError(
        rtContextSetAttribute(m_context, RT_CONTEXT_ATTRIBUTE_FORCE_INLINE_USER_FUNCTIONS, sizeof(value), &value));
}

inline void ContextObj::setDiskCacheLocation(const std::string& path) {
    checkError(
        rtContextSetAttribute(m_context, RT_CONTEXT_ATTRIBUTE_DISK_CACHE_LOCATION, sizeof(path.c_str()), path.c_str()));
}
...
inline void ContextObj::setDiskCacheMemoryLimits(RTsize lowWaterMark, RTsize highWaterMark) {
    ...
    checkError(rtContextSetAttribute(m_context, RT_CONTEXT_ATTRIBUTE_DISK_CACHE_MEMORY_LIMITS, sizeof(limits), limits));
}

inline void ContextObj::getDiskCacheMemoryLimits(RTsize& lowWaterMark, RTsize& highWaterMark) {
    RTsize limits[2] = {0};
    checkError(rtContextGetAttribute(m_context, RT_CONTEXT_ATTRIBUTE_DISK_CACHE_MEMORY_LIMITS, sizeof(limits), limits));
    lowWaterMark = limits[0];
    highWaterMark = limits[1];
}

inline void ContextObj::setGPUPagingForcedOff(int gpu_paging_forced_off) {
    checkError(rtContextSetAttribute(m_context, RT_CONTEXT_ATTRIBUTE_GPU_PAGING_FORCED_OFF,
                                     sizeof(gpu_paging_forced_off), &gpu_paging_forced_off));
}
...
inline void ContextObj::compile() { checkError(rtContextCompile(m_context)); }
...
// Progressive API
inline void ContextObj::launchProgressive(unsigned int entry_point_index, RTsize image_width, RTsize image_height,
                                          unsigned int max_subframes) {
    checkError(rtContextLaunchProgressive2D(m_context, entry_point_index, image_width, image_height, max_subframes));
}

inline void ContextObj::stopProgressive() { checkError(rtContextStopProgressive(m_context)); }
...
inline void ContextObj::setPrintEnabled(bool enabled) { checkError(rtContextSetPrintEnabled(m_context, enabled)); }
...
inline void ContextObj::removeVariable(Variable v) { checkError(rtContextRemoveVariable(m_context, v->get())); }
...
inline RTcontext ContextObj::get() { return m_context; }
...
inline void ProgramObj::validate() { checkError(rtProgramValidate(m_program)); }
...
inline void ProgramObj::removeVariable(Variable v) { checkError(rtProgramRemoveVariable(m_program, v->get())); }
...
inline void ProgramObj::setCallsitePotentialCallees(const std::string& callSiteName,
                                                    const std::vector<int>& calleeIds) {
    if (!calleeIds.empty())
...
inline RTprogram ProgramObj::get() { return m_program; }
...
inline void GroupObj::validate() { checkError(rtGroupValidate(m_group)); }
...
inline void SelectorObj::validate() { checkError(rtSelectorValidate(m_selector)); }
...
inline void SelectorObj::setChildCount(unsigned int count) { checkError(rtSelectorSetChildCount(m_selector, count)); }
...
inline void SelectorObj::removeChild(int index) { removeChild(static_cast<unsigned int>(index)); }
...
inline void SelectorObj::removeVariable(Variable v) { checkError(rtSelectorRemoveVariable(m_selector, v->get())); }
...
inline RTselector SelectorObj::get() { return m_selector; }
...
inline void GroupObj::setChildCount(unsigned int count) { checkError(rtGroupSetChildCount(m_group, count)); }
...
inline void GroupObj::removeChild(int index) { removeChild(static_cast<unsigned int>(index)); }
...
inline void GroupObj::setVisibilityMask(RTvisibilitymask mask) { checkError(rtGroupSetVisibilityMask(m_group, mask)); }
...
inline RTgroup GroupObj::get() { return m_group; }
...
inline void GeometryGroupObj::validate() { checkError(rtGeometryGroupValidate(m_geometrygroup)); }
...
inline void GeometryGroupObj::removeChild(int index) { removeChild(static_cast<unsigned int>(index)); }
...
inline RTgeometrygroup GeometryGroupObj::get() { return m_geometrygroup; }
...
inline void TransformObj::validate() { checkError(rtTransformValidate(m_transform)); }
...
inline void TransformObj::getMotionKeys(float* keys) { checkError(rtTransformGetMotionKeys(m_transform, keys)); }

inline RTtransform TransformObj::get() { return m_transform; }
...
inline void AccelerationObj::validate() { checkError(rtAccelerationValidate(m_acceleration)); }
...
inline void AccelerationObj::markDirty() { checkError(rtAccelerationMarkDirty(m_acceleration)); }
...
inline void AccelerationObj::getData(void* data) const { checkError(rtAccelerationGetData(m_acceleration, data)); }

inline void AccelerationObj::setData(const void* data, RTsize size) {
    checkError(rtAccelerationSetData(m_acceleration, data, size));
}

inline RTacceleration AccelerationObj::get() { return m_acceleration; }
...
inline void GeometryInstanceObj::validate() { checkError(rtGeometryInstanceValidate(m_geometryinstance)); }
...
inline RTgeometryinstance GeometryInstanceObj::get() { return m_geometryinstance; }
...
inline void GeometryObj::validate() { checkError(rtGeometryValidate(m_geometry)); }
...
inline void GeometryObj::setMotionSteps(unsigned int n) { checkError(rtGeometrySetMotionSteps(m_geometry, n)); }
...
inline void GeometryObj::removeVariable(Variable v) { checkError(rtGeometryRemoveVariable(m_geometry, v->get())); }
...
inline void GeometryObj::setFlags(RTgeometryflags flags) { checkError(rtGeometrySetFlags(m_geometry, flags)); }
...
inline void GeometryObj::markDirty() { checkError(rtGeometryMarkDirty(m_geometry)); }
...
inline RTgeometry GeometryObj::get() { return m_geometry; }
...
inline void GeometryTrianglesObj::validate() { checkError(rtGeometryTrianglesValidate(m_geometryTriangles)); }
...
inline void GeometryTrianglesObj::setTriangleIndices(Buffer index_buffer, RTsize index_buffer_byte_offset,
                                                     RTformat tri_indices_format) {
    setTriangleIndices(index_buffer, index_buffer_byte_offset, index_buffer->getElementSize(), tri_indices_format);
}

inline void GeometryTrianglesObj::setTriangleIndices(Buffer index_buffer, RTsize index_buffer_byte_offset,
                                                     RTsize tri_indices_byte_stride, RTformat tri_indices_format) {
...
inline void GeometryTrianglesObj::setVertices(unsigned int num_vertices, Buffer vertex_buffer,
                                              RTformat position_format) {
    setVertices(num_vertices, vertex_buffer, 0, position_format);
}

inline void GeometryTrianglesObj::setVertices(unsigned int num_vertices, Buffer vertex_buffer,
                                              RTsize vertex_buffer_byte_offset, RTformat position_format) {
    setVertices(num_vertices, vertex_buffer, vertex_buffer_byte_offset, vertex_buffer->getElementSize(),
                position_format);
}

inline void GeometryTrianglesObj::setVertices(unsigned int num_vertices, Buffer vertex_buffer,
                                              RTsize vertex_buffer_byte_offset, RTsize vertex_byte_stride,
                                              RTformat position_format) {
...
inline void GeometryTrianglesObj::setMotionVertices(unsigned int num_vertices, Buffer vertex_buffer,
                                                    RTsize vertex_buffer_byte_offset, RTsize vertex_byte_stride,
                                                    RTsize vertex_motion_step_byte_stride, RTformat position_format) {
    checkError(rtGeometryTrianglesSetMotionVertices(m_geometryTriangles, num_vertices, vertex_buffer->get(),
...
inline void GeometryTrianglesObj::setMotionVerticesMultiBuffer(unsigned int num_vertices,
    ...
    checkError(rtGeometryTrianglesSetMotionVerticesMultiBuffer(
        m_geometryTriangles, num_vertices, count > 0 ? &buffers[0] : 0, (unsigned int)count, vertex_buffer_byte_offset,
...
inline void GeometryTrianglesObj::getMotionBorderMode(RTmotionbordermode& beginMode,
                                                      RTmotionbordermode& endMode) const {
...
inline void GeometryTrianglesObj::setMaterialIndices(Buffer material_index_buffer,
    ...
    checkError(rtGeometryTrianglesSetMaterialIndices(m_geometryTriangles, material_index_buffer->get(),
                                                     material_index_buffer_byte_offset, material_index_byte_stride,
                                                     material_index_format));
}
...
inline RTgeometrytriangles GeometryTrianglesObj::get() { return m_geometryTriangles; }
...
inline void MaterialObj::validate() { checkError(rtMaterialValidate(m_material)); }
...
inline void MaterialObj::removeVariable(Variable v) { checkError(rtMaterialRemoveVariable(m_material, v->get())); }
...
inline RTmaterial MaterialObj::get() { return m_material; }
...
inline RTpostprocessingstage PostprocessingStageObj::get() { return m_stage; }
...
inline void CommandListObj::appendPostprocessingStage(PostprocessingStage stage, RTsize launch_width,
...
template <class Iterator>
inline void CommandListObj::setDevices(Iterator begin, Iterator end) {
    std::vector<int> devices(begin, end);
...
inline std::vector<int> CommandListObj::getDevices() const {
    ...
    if (count > 0) checkError(rtCommandListGetDevices(m_list, &devices[0]));
    return devices;
}
...
inline RTcommandlist CommandListObj::get() { return m_list; }
...
inline void TextureSamplerObj::validate() { checkError(rtTextureSamplerValidate(m_texturesampler)); }
...
inline void TextureSamplerObj::setFilteringModes(RTfiltermode minification, RTfiltermode magnification,
...
inline void TextureSamplerObj::getFilteringModes(RTfiltermode& minification, RTfiltermode& magnification,
                                                 RTfiltermode& mipmapping) const {
...
inline RTtexturesampler TextureSamplerObj::get() { return m_texturesampler; }

inline void TextureSamplerObj::registerGLTexture() { checkError(rtTextureSamplerGLRegister(m_texturesampler)); }

inline void TextureSamplerObj::unregisterGLTexture() { checkError(rtTextureSamplerGLUnregister(m_texturesampler)); }
...
inline void BufferObj::validate() { checkError(rtBufferValidate(m_buffer)); }
...
inline void BufferObj::setFormat(RTformat format) { checkError(rtBufferSetFormat(m_buffer, format)); }
...
inline void BufferObj::markDirty() { checkError(rtBufferMarkDirty(m_buffer)); }

inline void BufferObj::setSize(RTsize width) { checkError(rtBufferSetSize1D(m_buffer, width)); }

inline void BufferObj::getSize(RTsize& width) const { checkError(rtBufferGetSize1D(m_buffer, &width)); }
...
inline void BufferObj::setSize(RTsize width, RTsize height) { checkError(rtBufferSetSize2D(m_buffer, width, height)); }
...
inline void BufferObj::setMipLevelCount(unsigned int levels) { checkError(rtBufferSetMipLevelCount(m_buffer, levels)); }
...
inline void BufferObj::registerGLBuffer() { checkError(rtBufferGLRegister(m_buffer)); }

inline void BufferObj::unregisterGLBuffer() { checkError(rtBufferGLUnregister(m_buffer)); }

inline void* BufferObj::map(unsigned int level, unsigned int map_flags, void* user_owned) {
    // Note: the order of the 'level' and 'map_flags' argument flips here for compatibility with older versions of this
    // wrapper
    void* result;
...
inline void BufferObj::unmap(unsigned int level) { checkError(rtBufferUnmapEx(m_buffer, level)); }

inline void BufferObj::bindProgressiveStream(Buffer source) {
    checkError(rtBufferBindProgressiveStream(m_buffer, source->get()));
}

inline void BufferObj::getProgressiveUpdateReady(int* ready, unsigned int* subframe_count,
                                                 unsigned int* max_subframes) {
...
inline RTbuffer BufferObj::get() { return m_buffer; }
...
inline void VariableObj::setUint(unsigned int u1) { checkError(rtVariableSet1ui(m_variable, u1)); }

inline void VariableObj::setUint(unsigned int u1, unsigned int u2) { checkError(rtVariableSet2ui(m_variable, u1, u2)); }
...
inline void VariableObj::setUint(optix::uint2 u) { checkError(rtVariableSet2uiv(m_variable, &u.x)); }

inline void VariableObj::setUint(optix::uint3 u) { checkError(rtVariableSet3uiv(m_variable, &u.x)); }

inline void VariableObj::setUint(optix::uint4 u) { checkError(rtVariableSet4uiv(m_variable, &u.x)); }

inline void VariableObj::set1uiv(const unsigned int* u) { checkError(rtVariableSet1uiv(m_variable, u)); }

inline void VariableObj::set2uiv(const unsigned int* u) { checkError(rtVariableSet2uiv(m_variable, u)); }

inline void VariableObj::set3uiv(const unsigned int* u) { checkError(rtVariableSet3uiv(m_variable, u)); }

inline void VariableObj::set4uiv(const unsigned int* u) { checkError(rtVariableSet4uiv(m_variable, u)); }
...
inline void VariableObj::setFloat(float f1) { checkError(rtVariableSet1f(m_variable, f1)); }

inline void VariableObj::setFloat(optix::float2 f) { checkError(rtVariableSet2fv(m_variable, &f.x)); }

inline void VariableObj::setFloat(float f1, float f2) { checkError(rtVariableSet2f(m_variable, f1, f2)); }

inline void VariableObj::setFloat(optix::float3 f) { checkError(rtVariableSet3fv(m_variable, &f.x)); }

inline void VariableObj::setFloat(float f1, float f2, float f3) { checkError(rtVariableSet3f(m_variable, f1, f2, f3)); }

inline void VariableObj::setFloat(optix::float4 f) { checkError(rtVariableSet4fv(m_variable, &f.x)); }

inline void VariableObj::setFloat(float f1, float f2, float f3, float f4) {
    checkError(rtVariableSet4f(m_variable, f1, f2, f3, f4));
}

inline void VariableObj::set1fv(const float* f) { checkError(rtVariableSet1fv(m_variable, f)); }

inline void VariableObj::set2fv(const float* f) { checkError(rtVariableSet2fv(m_variable, f)); }

inline void VariableObj::set3fv(const float* f) { checkError(rtVariableSet3fv(m_variable, f)); }

inline void VariableObj::set4fv(const float* f) { checkError(rtVariableSet4fv(m_variable, f)); }

///////
inline void VariableObj::setInt(int i1) { checkError(rtVariableSet1i(m_variable, i1)); }

inline void VariableObj::setInt(optix::int2 i) { checkError(rtVariableSet2iv(m_variable, &i.x)); }

inline void VariableObj::setInt(int i1, int i2) { checkError(rtVariableSet2i(m_variable, i1, i2)); }

inline void VariableObj::setInt(optix::int3 i) { checkError(rtVariableSet3iv(m_variable, &i.x)); }

inline void VariableObj::setInt(int i1, int i2, int i3) { checkError(rtVariableSet3i(m_variable, i1, i2, i3)); }

inline void VariableObj::setInt(optix::int4 i) { checkError(rtVariableSet4iv(m_variable, &i.x)); }

inline void VariableObj::setInt(int i1, int i2, int i3, int i4) {
    checkError(rtVariableSet4i(m_variable, i1, i2, i3, i4));
}

inline void VariableObj::set1iv(const int* i) { checkError(rtVariableSet1iv(m_variable, i)); }

inline void VariableObj::set2iv(const int* i) { checkError(rtVariableSet2iv(m_variable, i)); }

inline void VariableObj::set3iv(const int* i) { checkError(rtVariableSet3iv(m_variable, i)); }

inline void VariableObj::set4iv(const int* i) { checkError(rtVariableSet4iv(m_variable, i)); }

///////
inline void VariableObj::setLongLong(long long i1) { checkError(rtVariableSet1ll(m_variable, i1)); }

inline void VariableObj::setLongLong(optix::longlong2 i) { checkError(rtVariableSet2llv(m_variable, &i.x)); }

inline void VariableObj::setLongLong(long long i1, long long i2) { checkError(rtVariableSet2ll(m_variable, i1, i2)); }

inline void VariableObj::setLongLong(optix::longlong3 i) { checkError(rtVariableSet3llv(m_variable, &i.x)); }
...
inline void VariableObj::setLongLong(optix::longlong4 i) { checkError(rtVariableSet4llv(m_variable, &i.x)); }
...
inline void VariableObj::set1llv(const long long* i) { checkError(rtVariableSet1llv(m_variable, i)); }

inline void VariableObj::set2llv(const long long* i) { checkError(rtVariableSet2llv(m_variable, i)); }

inline void VariableObj::set3llv(const long long* i) { checkError(rtVariableSet3llv(m_variable, i)); }

inline void VariableObj::set4llv(const long long* i) { checkError(rtVariableSet4llv(m_variable, i)); }

///////
inline void VariableObj::setULongLong(unsigned long long i1) { checkError(rtVariableSet1ull(m_variable, i1)); }

inline void VariableObj::setULongLong(optix::ulonglong2 i) { checkError(rtVariableSet2ullv(m_variable, &i.x)); }
...
inline void VariableObj::setULongLong(optix::ulonglong3 i) { checkError(rtVariableSet3ullv(m_variable, &i.x)); }
...
inline void VariableObj::setULongLong(optix::ulonglong4 i) { checkError(rtVariableSet4ullv(m_variable, &i.x)); }
...
inline void VariableObj::set1ullv(const unsigned long long* i) { checkError(rtVariableSet1ullv(m_variable, i)); }

inline void VariableObj::set2ullv(const unsigned long long* i) { checkError(rtVariableSet2ullv(m_variable, i)); }

inline void VariableObj::set3ullv(const unsigned long long* i) { checkError(rtVariableSet3ullv(m_variable, i)); }

inline void VariableObj::set4ullv(const unsigned long long* i) { checkError(rtVariableSet4ullv(m_variable, i)); }

inline void VariableObj::setBuffer(Buffer buffer) { checkError(rtVariableSetObject(m_variable, buffer->get())); }

inline void VariableObj::set(Buffer buffer) { checkError(rtVariableSetObject(m_variable, buffer->get())); }
...
inline void VariableObj::set(GeometryGroup group) { checkError(rtVariableSetObject(m_variable, group->get())); }

inline void VariableObj::set(Group group) { checkError(rtVariableSetObject(m_variable, group->get())); }

inline void VariableObj::set(Program program) { checkError(rtVariableSetObject(m_variable, program->get())); }
...
inline void VariableObj::set(Selector sel) { checkError(rtVariableSetObject(m_variable, sel->get())); }

inline void VariableObj::set(Transform tran) { checkError(rtVariableSetObject(m_variable, tran->get())); }
...
inline RTvariable VariableObj::get() { return m_variable; }
...
inline optix::GeometryInstance VariableObj::getGeometryInstance() const {
    RTobject temp;
    checkError(rtVariableGetObject(m_variable, &temp));
    RTgeometryinstance geometryinstance = reinterpret_cast<RTgeometryinstance>(temp);
    return GeometryInstance::take(geometryinstance);
}
...
inline void VariableObj::getFloat(float& f1) const { checkError(rtVariableGet1f(m_variable, &f1)); }

inline void VariableObj::getFloat(float& f1, float& f2) const { checkError(rtVariableGet2f(m_variable, &f1, &f2)); }

inline void VariableObj::getFloat(float& f1, float& f2, float& f3) const {
    checkError(rtVariableGet3f(m_variable, &f1, &f2, &f3));
}

inline void VariableObj::getFloat(float& f1, float& f2, float& f3, float& f4) const {
...
inline void VariableObj::getUint(unsigned& u1) const { checkError(rtVariableGet1ui(m_variable, &u1)); }
...
inline void VariableObj::getUint(unsigned& u1, unsigned& u2, unsigned& u3, unsigned& u4) const {
...
inline void VariableObj::getInt(int& i1) const { checkError(rtVariableGet1i(m_variable, &i1)); }

inline void VariableObj::getInt(int& i1, int& i2) const { checkError(rtVariableGet2i(m_variable, &i1, &i2)); }
...
inline void VariableObj::getULongLong(unsigned long long& ull1, unsigned long long& ull2, unsigned long long& ull3,
                                      unsigned long long& ull4) const {
...
inline void VariableObj::getLongLong(long long& ll1) const { checkError(rtVariableGet1ll(m_variable, &ll1)); }
