...
// }
//
// TEST_CASE("Context::copyPrimitive (triangle)") {
//     Context context_test;
//
//     vec3 v0 = make_vec3(0, 0, 0);
//     vec3 v1 = make_vec3(1, 0, 0);
...
// }
//
// TEST_CASE("Context::addBoxObject") {
//     Context context_test;
//
//     vec3 center = make_vec3(1, 2, 3);
//     vec3 size = make_vec3(3, 2, 1);
...
// }
//
// TEST_CASE("Context::addTileObject rotated") {
//     Context context_test;
//
//     vec3 center = make_vec3(1, 2, 3);
//     vec2 size = make_vec2(3, 2);
...
// }
//
// TEST_CASE("Context primitive bounding box") {
//     Context context_test;
//     std::vector<uint> UUIDs;
//     UUIDs.push_back(context_test.addPatch(make_vec3(-1, 0, 0), make_vec2(0.5, 0.5)));
//     UUIDs.push_back(context_test.addPatch(make_vec3(1, 0, 0), make_vec2(0.5, 0.5)));
...
// }
//
// TEST_CASE("Context primitive scale and data") {
//     Context context_test;
//     vec2 sz_0 = make_vec2(0.5f, 3.f);
//     float area0 = sz_0.x * sz_0.y;
//     float scale = 2.6f;
...
// }
//
// TEST_CASE("Context error handling") {
//     Context context_test;
//     uint tri = context_test.addTriangle(make_vec3(0, 0, 0), make_vec3(1, 0, 0), make_vec3(0, 1, 0), RGB::green);
//     capture_cerr cerr_buffer;
//     vec3 center;
...
// }
//
// TEST_CASE("Context textured tile area") {
//     Context context_test;
//
//     vec3 center = make_vec3(1, 2, 3);
//     vec2 size = make_vec2(3, 2);
...
// }
//
// TEST_CASE("Context texture uv and solid fraction") {
//     Context context_test;
//
//     vec2 sizep = make_vec2(2, 3);
//     const char *texture = "lib/images/disk_texture.png";
...
// }
//
// TEST_CASE("Context global and object data") {
//     Context context_test;
//     float gdata = 5.f;
//     context_test.setGlobalData("some_data", gdata);
//     float gdata_r;
...
// }
//
// TEST_CASE("Context cone object transforms") {
//     Context context_test;
//     float r0 = 0.5f, r1 = 1.f, len = 2.f;
//     vec3 node0 = make_vec3(0, 0, 0);
//     vec3 node1 = make_vec3(0, 0, len);
...
// }
//
// TEST_CASE("Context coordinate conversions") {
//     SphericalCoord sph = make_SphericalCoord(1.f, 0.25 * PI_F, 1.5 * PI_F);
//     vec3 cart = sphere2cart(sph);
//     SphericalCoord sph2 = cart2sphere(cart);
//     DOCTEST_CHECK(sph.radius == doctest::Approx(sph2.radius).epsilon(errtol));
...
// }
//
// TEST_CASE("Context Julian day conversion") {
//     int year = 2000;
//     Date d = Julian2Calendar(10, year);
//     DOCTEST_CHECK(d.year == year);
//     DOCTEST_CHECK(d.month == 1);
...
// }
//
// TEST_CASE("Context spline interpolation") {
//     vec3 p0 = make_vec3(0, 0, 0);
//     vec3 t0 = make_vec3(3, 0, 0);
//     vec3 p1 = make_vec3(1, 1.5, 0.4);
//     vec3 t1 = make_vec3(0, 1, 0);
...
// }
//
// TEST_CASE("helios_vector_types coverage") {
//     SUBCASE("int2") {
//         int2 v0(1, 2);
//         int2 v1(3, 4);
//         DOCTEST_CHECK(v0.x == 1);
...
//     }
//
//     SUBCASE("deblank and trim_whitespace") {
//         DOCTEST_CHECK(deblank("  hello world  ") == "helloworld");
//         DOCTEST_CHECK(trim_whitespace("  hello world  ") == "hello world");
//     }
//
//     SUBCASE("separate_string_by_delimiter") {
//         std::vector<std::string> result = separate_string_by_delimiter("a,b,c", ",");
//         DOCTEST_CHECK(result.size() == 3);
//         if (result.size() == 3) {
//             DOCTEST_CHECK(result[0] == "a");
...
// }
//
// TEST_CASE("global.h matrix and vector operations") {
//     float M[16], T[16], R[16];
//
//     SUBCASE("makeIdentityMatrix") {
//         makeIdentityMatrix(T);
...
// }
//
// TEST_CASE("global.h parsing functions") {
//     SUBCASE("parse_float, parse_double, parse_int, parse_uint") {
//         float f;
//         DOCTEST_CHECK(parse_float("1.23", f));
//         DOCTEST_CHECK(f == doctest::Approx(1.23f));
//         DOCTEST_CHECK(!parse_float("abc", f));
...
// }
//
// TEST_CASE("global.h geometric functions") {
//     SUBCASE("atan2_2pi") {
//         DOCTEST_CHECK(atan2_2pi(0, 1) == doctest::Approx(0));
//         DOCTEST_CHECK(atan2_2pi(1, 0) == doctest::Approx(PI_F / 2.0));
//         DOCTEST_CHECK(atan2_2pi(0, -1) == doctest::Approx(PI_F));
...
// }
//
// TEST_CASE("global.h vector utilities") {
//     SUBCASE("resize_vector") {
//         std::vector<std::vector<int>> vec2d;
//         resize_vector(vec2d, 2, 3);
//         DOCTEST_CHECK(vec2d.size() == 3);
...
// }
//
// TEST_CASE("global.h miscellaneous") {
//     SUBCASE("interp1") {
//         std::vector<vec2> points = {{0, 0}, {1, 1}, {2, 0}};
//         float res = interp1(points, 0.5f);
//         DOCTEST_CHECK(res == doctest::Approx(0.5f));
...
// }
//
// TEST_CASE("Vector statistics extra") {
//     SUBCASE("min/max int/vec3") {
//         std::vector<int> vi = {1, 2, 3, 4, 5};
//         int min_vi = min(vi);
//         int max_vi = max(vi);
//         DOCTEST_CHECK(min_vi == 1);
//         DOCTEST_CHECK(max_vi == 5);
//
//         std::vector<vec3> vv = {{1, 2, 3}, {0, 5, 2}, {3, 1, 4}};
//         vec3 min_vv = min(vv);
//         vec3 max_vv = max(vv);
//         DOCTEST_CHECK(min_vv == vec3(0, 1, 2));
//         DOCTEST_CHECK(max_vv == vec3(3, 5, 4));
//     }
//     SUBCASE("empty vector throws") {
//         capture_cerr cerr_buffer;
//         std::vector<float> vf_empty;
//         float result_float;
//         DOCTEST_CHECK_THROWS(result_float=sum(vf_empty));
//         DOCTEST_CHECK_THROWS(result_float=mean(vf_empty));
//         DOCTEST_CHECK_THROWS(result_float=min(vf_empty));
//         DOCTEST_CHECK_THROWS(result_float=max(vf_empty));
//         DOCTEST_CHECK_THROWS(result_float=stdev(vf_empty));
//         DOCTEST_CHECK_THROWS(result_float=median(vf_empty));
//
//         std::vector<int> vi_empty;
//         float result_int;
//         DOCTEST_CHECK_THROWS(result_int=min(vi_empty));
//         DOCTEST_CHECK_THROWS(result_int=max(vi_empty));
//
//         std::vector<vec3> vv_empty;
//         vec2 result_vec2;
//         vec3 result_vec3;
//         vec4 result_vec4;
//         int2 result_int2;
//         int3 result_int3;
//         int4 result_int4;
//         DOCTEST_CHECK_THROWS(result_vec3=min(vv_empty));
//         DOCTEST_CHECK_THROWS(result_vec3=max(vv_empty));
//     }
// }
//
// TEST_CASE("rotatePoint with SphericalCoord") {
//     vec3 p(1, 0, 0);
//     SphericalCoord rot;
//     DOCTEST_CHECK_NOTHROW(rot = make_SphericalCoord(1, PI_F / 2.f, PI_F / 2.f));
//     vec3 rotated = rotatePoint(p, rot);
//     DOCTEST_CHECK(rotated.x == doctest::Approx(0.f));
//     DOCTEST_CHECK(rotated.y == doctest::Approx(0.f));
//     DOCTEST_CHECK(rotated.z == doctest::Approx(-1.f));
// }
//
// TEST_CASE("makeRotationMatrix about point") {
//     float T[16];
//     makeRotationMatrix(PI_F / 2.f, vec3(1, 1, 1), vec3(0, 0, 1), T);
//     vec3 v(2, 1, 1);
//     vec3 res;
//     vecmult(T, v, res);
//     DOCTEST_CHECK(res.x == doctest::Approx(1.f));
//     DOCTEST_CHECK(res.y == doctest::Approx(2.f));
//     DOCTEST_CHECK(res.z == doctest::Approx(1.f));
// }
//
// TEST_CASE("global.h additional coverage") {
//     SUBCASE("string to vector conversions with invalid input") {
...
// }
//
// TEST_CASE("Angle conversion helpers") {
//     CHECK(deg2rad(180.f) == doctest::Approx(PI_F).epsilon(errtol));
//     CHECK(rad2deg(PI_F) == doctest::Approx(180.f).epsilon(errtol));
//
//     CHECK(atan2_2pi(0.f, 1.f) == doctest::Approx(0.f).epsilon(errtol));
...
// }
//
// TEST_CASE("clamp template for common types") {
//     CHECK(clamp(5, 1, 4) == 4);
//     CHECK(clamp(-1, 0, 10) == 0);
//     CHECK(clamp(3.5f, 0.f, 10.f) == doctest::Approx(3.5f).epsilon(errtol));
//     CHECK(clamp(12.0, -5.0, 11.0) == doctest::Approx(11.0).epsilon(errtol));
// }
//
// TEST_CASE("sum / mean / min / max / stdev / median") {
//     std::vector<float> vf{1.f, 2.f, 3.f, 4.f, 5.f};
//     CHECK(sum(vf) == doctest::Approx(15.f).epsilon(errtol));
//     CHECK(mean(vf) == doctest::Approx(3.f).epsilon(errtol));
//     CHECK(min(vf) == doctest::Approx(1.f).epsilon(errtol));
...
// }
//
// TEST_CASE("makeIdentityMatrix / matmult / vecmult") {
//     float I[16] = {};
//     makeIdentityMatrix(I);
//     for (int r = 0; r < 4; ++r) {
//         for (int c = 0; c < 4; ++c) {
...
// }
//
// TEST_CASE("rotatePoint & rotatePointAboutLine") {
//     vec3 p = make_vec3(1, 0, 0);
//     // Rotate 90° about z -> y axis
//     vec3 r = rotatePoint(p, 0.f, 0.5f * PI_F);
//     CHECK(r.x == doctest::Approx(0.f).epsilon(errtol));
...
// }
//
// TEST_CASE("Date helpers: leap year, JulianDay and incrementDay") {
//     Date d{28, 2, 2000};
//     CHECK(d.isLeapYear());
//     CHECK(d.JulianDay() == 31 + 28); // Feb 28 in leap year (day 31 + 28)
//
//     d.incrementDay(); // Feb 29
//     CHECK(d.day == 29);
//     d.incrementDay(); // Mar 1
//     CHECK(d.month == 3);
//
//     Date end{31, 12, 2021};
//     end.incrementDay();
...
// }
//
// TEST_CASE("acos_safe & asin_safe clamp inputs") {
//     CHECK(acos_safe(1.5f) == doctest::Approx(0.f).epsilon(errtol));
//     CHECK(asin_safe(-2.f) == doctest::Approx(-0.5f * PI_F).epsilon(errtol));
// }
//
// TEST_CASE("randu range checks") {
//     for (int i = 0; i < 100; ++i) {
//         float r = randu();
//         CHECK(r >= 0.f);
//         CHECK(r <= 1.f);
...
// }
//
// TEST_CASE("Context_data coverage") {
//
//     SUBCASE("Primitive data") {
//         Context ctx;
//         uint p = ctx.addPatch();
